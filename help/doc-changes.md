...
| 날짜 | 설명 업데이트 |
| --- | --- |
| 2021년 11월 | 설명서가 업데이트되었습니다. [[!UICONTROL 건너뛴 레코드]](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-connections/manage-connections.html?lang=en#connection-details-settings) 연결 세부 정보 페이지에서 확인할 수 있습니다. |
...
| 2021년 10월 | 문서화된 [Analytics 대시보드의 시각화](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-dashboards/create-scorecard.html?lang=en#apply-visualizations) |
| 2021년 10월 | [!UICONTROL 연결] [데이터 보존](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-connections/manage-connections.html?lang=en#set-rolling-window-for-connection-data-retention)을 위한 롤링 기간.<p>**참고: 이 설정을 구현하려면 고객 지원 센터 또는 Adobe 계정 관리자에게 문의하십시오. 아직 CJA UI를 통해서는 사용할 수 없습니다.** |
...
| 2021년 9월 | CJA에서 [보고서 세트 병합의 의미](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-overview/cja-faq.html?lang=en#6.-considerations-when-merging-report-suites-in-cja)에 대한 새로운 섹션. |
...
| 2021년 8월 | [데이터 보기 차원의 대소문자 구분](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-dataviews/create-dataview.html?lang=en#configure-behavior-settings)에 대한 새로운 섹션. |
| 2021년 6월 | 작업 영역의 [이전 프로젝트 버전](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-workspace/build-workspace-project/save-projects.html?lang=en#previous-version)에 대한 새로운 설명서. |
| 2021년 4월 | [지속성](data-views/component-settings/persistence.md)에 대한 새로운 주제. |
...
| 2021년 1월 | 새 항목 [데이터 세트에 표준 조회 추가](/help/connections/standard-lookups.md). |
...
| 2020년 11월 | 연결을 위한 [채우기 제한 제거](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-connections/create-connection.html?lang=en#backfill-historical-data)에 대한 콘텐츠를 추가했습니다. |
...
| 2020년 9월 2일 | [사용자 권한](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-overview/cja-overview.html?lang=en) 섹션이 업데이트되었습니다. |
