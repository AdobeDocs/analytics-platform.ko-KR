...
>title="개인 ID 변경"
>abstract="개인 ID를 변경하면 연결의 모든 기존 데이터가 삭제되고 새로운 개인 ID를 기반으로 데이터 세트의 모든 데이터가 다시 수집됩니다. 이러한 작업을 수행하면 비용이 발생할 수 있습니다. <br/><br/>**[!UICONTROL 계속]**&#x200B;을 선택하면 프로세스가 완료될 때까지 보고가 지연될 수 있습니다."

>[!CONTEXTUALHELP]
>id="connection_change_accountid"
>title="계정 ID 변경"
>abstract="계정 ID를 변경하면 연결의 모든 기존 데이터가 삭제되고 새로운 계정 ID를 기반으로 데이터 세트의 모든 데이터가 다시 수집됩니다. 이러한 작업을 수행하면 비용이 발생할 수 있습니다. <br/><br/>**[!UICONTROL 계속]**&#x200B;을 선택하면 프로세스가 완료될 때까지 보고가 지연될 수 있습니다."

>[!CONTEXTUALHELP]
>id="connection_change_globalaccountid"
>title="글로벌 계정 ID 변경"
>abstract="글로벌 계정 ID를 변경하면 연결의 모든 기존 데이터가 삭제되고 새로운 글로벌 계정 ID를 기반으로 데이터 세트의 모든 데이터가 다시 수집됩니다. 이러한 작업을 수행하면 비용이 발생할 수 있습니다. <br/><br/>**[!UICONTROL 계속]**&#x200B;을 선택하면 프로세스가 완료될 때까지 보고가 지연될 수 있습니다."

>[!CONTEXTUALHELP]
>id="connection_change_opportunityid"
>title="기회 ID 변경"
>abstract="기회 ID를 변경하면 연결의 모든 기존 데이터가 삭제되고 새로운 기회 ID를 기반으로 데이터 세트의 모든 데이터가 다시 수집됩니다. 이러한 작업을 수행하면 비용이 발생할 수 있습니다. <br/><br/>**[!UICONTROL 계속]**&#x200B;을 선택하면 프로세스가 완료될 때까지 보고가 지연될 수 있습니다."

>[!CONTEXTUALHELP]
>id="connection_change_buyinggroupid"
>title="구매 그룹 ID 변경"
>abstract="구매 그룹 ID를 변경하면 연결의 모든 기존 데이터가 삭제되고 새로운 구매 그룹 ID를 기반으로 데이터 세트의 모든 데이터가 다시 수집됩니다. 이러한 작업을 수행하면 비용이 발생할 수 있습니다. <br/><br/>**[!UICONTROL 계속]**&#x200B;을 선택하면 프로세스가 완료될 때까지 보고가 지연될 수 있습니다."
