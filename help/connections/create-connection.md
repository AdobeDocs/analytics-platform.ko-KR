...
>title="ID 결합 활성화"
>abstract="ID 결합을 활성화하면 데이터 세트 또는 ID 그래프에서 사용자 ID 정보를 파생합니다. 이 프로세스에는 인증된 세션과 인증되지 않은 세션의 사용자 데이터를 병합하는 작업이 포함될 수 있습니다.<br/><br/>해당 법률 및 규정을 준수할 책임은 사용자에게 있습니다. 이러한 규정 준수에는 데이터 세트에 대한 결합을 활성화하기 전에 필요한 최종 사용자 권한을 획득해야 한다는 내용이 포함됩니다."
>additional-url="https://experienceleague.adobe.com/ko/docs/analytics-platform/using/stitching/overview" text="결합 개요"
