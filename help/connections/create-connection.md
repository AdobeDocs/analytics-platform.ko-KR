...
>title="영구 ID 변경"
>abstract="영구 ID를 변경하면 연결에서 모든 기존 데이터가 삭제되고 새 영구 ID를 기반으로 데이터 세트에서 모든 데이터를 다시 수집합니다. 이 액션을 수행하면 비용이 발생할 수 있습니다. <br/><br/>**[!UICONTROL 계속]**&#x200B;을 선택하면 프로세스가 완료될 때까지 보고가 지연될 수 있습니다."
...
>title="개인 ID"
>abstract="Experience Platform의 데이터 세트 스키마에서 정의한 사용 가능한 ID에서 개인 ID(개인의 고유 식별자)를 선택합니다."

>[!CONTEXTUALHELP]
>id="cja_connection_matchingkey"
>title="일치하는 키"
>abstract="이벤트 데이터 세트 중 하나에 연결할 필드를 선택하십시오. 이 목록이 비어 있다면 이벤트 데이터 세트를 추가하거나 구성하지 않았을 가능성이 높습니다."
