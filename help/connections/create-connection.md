...
>title="개인 ID 변경"
>abstract="데이터 세트에 대한 ID 결합 설정을 수정하면 변경 사항을 적용한 후 개인 ID 설정에 영향을 미칩니다. 개인 ID를 변경하면 연결에 있는 기존 데이터가 모두 삭제됩니다. 새로운 개인 ID를 기반으로 데이터 세트에서 데이터를 다시 수집해야 합니다.<br/><br/>**[!UICONTROL 계속]**&#x200B;을 선택하면 삭제 프로세스가 완료될 때까지 보고가 지연될 수 있습니다."
...
>title="ID 결합 활성화"
>abstract="ID 결합을 활성화하면 데이터 세트 또는 ID 그래프에서 결합된 ID가 파생됩니다. 이 프로세스에는 인증된 세션과 인증되지 않은 세션의 사용자 데이터를 병합하는 작업이 포함될 수 있습니다.<br/><br/>해당 법률 및 규정을 준수할 책임은 사용자에게 있습니다. 이러한 규정 준수에는 데이터 세트에 대한 결합을 활성화하기 전에 필요한 최종 사용자 권한을 획득해야 한다는 내용이 포함됩니다."
>additional-url="https://experienceleague.adobe.com/ko/docs/analytics-platform/using/stitching/overview" text="결합 개요"
...
>title="다시 보기 창"
>abstract="재생 창에서 결합에 사용할 적절한 기간을 선택합니다."
>additional-url="https://experienceleague.adobe.com/ko/docs/analytics-platform/using/stitching/overview" text="결합 개요"
