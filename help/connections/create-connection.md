...
>title="법적 영향"
>abstract="Customer Journey Analytics 사용 시 통합 데이터 볼륨에 따라 추가 변경 사항이 발생할 수 있습니다. [Customer Journey Analytics 청구 및 사용에 대한 세부 정보](https://experienceleague.adobe.com/ko/docs/analytics-platform/using/cja-connections/manage-connections#connections-usage)를 참조하세요."
