...
**[!UICONTROL 연결]** > **[!UICONTROL 제목 없는 연결]** 화면에서:
...
1. 연결 설정을 구성합니다.
   ...
   | [!BADGE B2B edition]{type=Informative url="https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2b/cja-b2b-edition" newtab=true tooltip="Customer Journey Analytics B2B edition"}<br/>**[!UICONTROL 기본 ID ]** | 연결에 적합한 기본 ID를 선택합니다. <ul><li>B2C 시나리오의 ![사용자](/help/assets/icons/User.svg) **[!UICONTROL 사용자]**</li><li> B2B 시나리오에 대한 ![빌드](/help/assets/icons/Building.svg) **[!UICONTROL 계정]**</li></ul> |
   | [!BADGE B2B edition]{type=Informative url="https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2b/cja-b2b-edition" newtab=true tooltip="Customer Journey Analytics B2B edition"}<br/>**[!UICONTROL 선택적 컨테이너&#x200B;]** | 추가 컨테이너를 선택하십시오.<ul><li>**[!UICONTROL 글로벌 계정]**: 연결에서 글로벌 계정의 구성을 활성화합니다.</li><li>**[!UICONTROL 기회]**: 연결에서 기회의 구성을 활성화합니다.</li><li>**[!UICONTROL 구매 그룹]**: 연결에서 구매 그룹의 구성을 활성화합니다.</li><ul> |
   ...
   | **[!UICONTROL 데이터 세트 추가]** (아래 참조) | 데이터 세트 테이블에 데이터 세트가 표시되지 않으면 데이터 세트를 추가합니다. 그렇지 않으면 연결 만들기의 일부로 이미 추가한 데이터 세트 목록이 표시됩니다. |
   ...
   | [!BADGE B2B edition]{type=Informative url="https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2b/cja-b2b-edition" newtab=true tooltip="Customer Journey Analytics B2B edition"}<br/>**[!UICONTROL 계정 ID ]** | 데이터 세트에 대한 계정 기반 보고를 지원하는 데 사용되는 계정 ID입니다. |
   | [!BADGE B2B edition]{type=Informative url="https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2b/cja-b2b-edition" newtab=true tooltip="Customer Journey Analytics B2B edition"}<br/>**[!UICONTROL 글로벌 계정 ID ]** | 전역 계정 데이터를 조회하는 데 사용되는 전역 계정 ID입니다. |
   | [!BADGE B2B edition]{type=Informative url="https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2b/cja-b2b-edition" newtab=true tooltip="Customer Journey Analytics B2B edition"}<br/>**[!UICONTROL 구매 그룹 ID ]** | 구매 그룹 데이터를 조회하는 데 사용되는 구매 그룹 ID입니다. |
   | [!BADGE B2B edition]{type=Informative url="https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2b/cja-b2b-edition" newtab=true tooltip="Customer Journey Analytics B2B edition"}<br/>**[!UICONTROL 영업 기회 ID ]** | 영업 기회 데이터를 조회하는 데 사용되는 영업 기회 ID입니다. |
...
워크플로에서는 연결을 만들 때 하나 이상의 Experience Platform 데이터 세트를 추가할 수 있습니다.
...
1. 하나 이상의 데이터 세트를 선택하고 **[!UICONTROL 다음]**&#x200B;을 선택합니다. 각 데이터 세트를 [구성](#configure-datasets)합니다. 하나 이상의 이벤트 데이터 세트가 연결의 일부가 되어야 합니다.


## 데이터 세트 구성

**[!UICONTROL 데이터 세트 추가]** 대화 상자의 **[!UICONTROL 데이터 세트 설정]** 단계에서 선택한 ➋ 각 데이터 세트를 하나씩 구성합니다.
...
![데이터 세트 B2B 추가](assets/add-dataset-b2b.png)

>[!ENDTABS]

| 설정 | 설명 |
| --- | --- |
| [!BADGE B2B edition]{type=Informative url="https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2b/cja-b2b-edition" newtab=true tooltip="Customer Journey Analytics B2B edition"}<br/>**[!UICONTROL 계정 ID ]** | [컨테이너에서 일치](/help/getting-started/cja-b2b-concepts-features.md#match-by-container-or-field)하는 이벤트 데이터 세트와 조회 데이터 세트에만 사용할 수 있습니다. Experience Platform의 데이터 세트 스키마에 정의된 사용 가능한 ID에서 계정 ID(계정에 대한 고유 식별자)를 선택합니다. |
| [!BADGE B2B edition]{type=Informative url="https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2b/cja-b2b-edition" newtab=true tooltip="Customer Journey Analytics B2B edition"}<br/>**[!UICONTROL 영업 기회 ID ]** | 이벤트 데이터 세트에만 사용할 수 있습니다. Experience Platform의 데이터 세트 스키마에 정의된 사용 가능한 ID에서 기회 ID(기회에 대한 고유 식별자)를 선택합니다. |
| [!BADGE B2B edition]{type=Informative url="https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2b/cja-b2b-edition" newtab=true tooltip="Customer Journey Analytics B2B edition"}<br/>**[!UICONTROL 구매 그룹 ID ]** | 이벤트 데이터 세트에만 사용할 수 있습니다. Experience Platform의 데이터 세트 스키마에 정의된 사용 가능한 ID 중에서 구매 그룹 ID(구매 그룹에 대한 고유 식별자)를 선택합니다. |
...
| [!BADGE B2B edition]{type=Informative url="https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2b/cja-b2b-edition" newtab=true tooltip="Customer Journey Analytics B2B edition"} **[!UICONTROL 일치하는 키 유형]** | 데이터 집합을 조인하는 방법은 **[!UICONTROL 필드별 일치]** 또는 **[!UICONTROL 컨테이너별 일치]**&#x200B;를 기반으로 선택하십시오. 자세한 내용은 [필드의 컨테이너별 일치](/help/getting-started/cja-b2b-concepts-features.md#match-by-container-or-field)를 참조하십시오. |
| **[!UICONTROL 일치하는 키]** | 조회 또는 프로필 데이터 세트에만 사용할 수 있습니다. 이벤트 데이터 세트 중 하나에 연결할 일치하는 키입니다. 이 목록이 비어 있으면 이벤트 데이터 세트를 추가하거나 구성하지 않았을 수 있습니다. <br/><br/>[!BADGE B2B edition]{type=Informative url="https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2b/cja-b2b-edition" newtab=true tooltip="Customer Journey Analytics B2B edition"}<br/>선택한 **[!UICONTROL 일치하는 키 형식]**&#x200B;을(를) 기준으로 적절한 값을 선택하십시오.<ul><li>**[!UICONTROL 필드별 일치]**: 이벤트 데이터 세트 중 하나에 연결할 필드를 선택하십시오. 이 목록이 비어 있다면 이벤트 데이터 세트를 추가하거나 구성하지 않았을 가능성이 높습니다.</li><li>**[!UICONTROL 컨테이너별 일치]**: 이벤트 데이터 세트 중 하나와 연결하는 데 사용할 컨테이너를 선택하십시오. 선택할 수 있는 컨테이너는 연결 설정의 일부로 포함한 컨테이너에 의해 결정됩니다. 이 목록이 비어 있다면 하나 이상의 컨테이너를 구성하지 않은 것일 수 있습니다.</li></ul> |
| [!BADGE B2B edition]{type=Informative url="https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2b/cja-b2b-edition" newtab=true tooltip="Customer Journey Analytics B2B edition"}<br/>**[!UICONTROL 계정 필드&#x200B;]** | 계정 기반 보고에 사용할 계정 ID입니다. |
...
| **[!UICONTROL 제거]** | 전체 연결을 삭제하지 않고 데이터 세트를 삭제하거나 제거하고 [!UICONTROL 개인 ID] 또는 [!UICONTROL 계정 ID] [!BADGE B2B edition]{type=Informative url="https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2b/cja-b2b-edition" newtab=true tooltip="Customer Journey Analytics B2B edition"}을(를) 변경할 수 있습니다. 삭제 또는 제거하게 되면 데이터 수집과 관련된 비용과 전체 연결 및 관련 데이터 보기를 다시 만드는 번거로운 프로세스를 줄일 수 있습니다. |
...
이 맵을 사용하면 연결을 정의한 방법을 더 잘 이해하고 식별자를 사용하여 이벤트, 프로필 및 조회 데이터 세트 간의 관계를 설정할 수 있습니다.
