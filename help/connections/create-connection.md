...
>abstract="각 이벤트 수준에서 **[!UICONTROL primary]**(으)로 정의된 identityMap 네임스페이스를 자동으로 감지하고 사용합니다."
...
>title="ID 결합"
>abstract="ID 결합은 데이터 세트 또는 ID 그래프에서 사용자 ID 정보를 파생합니다. 이 프로세스에는 인증된 세션과 인증되지 않은 세션의 사용자 데이터를 병합하는 작업이 포함될 수 있습니다.<br/><br/>해당 법률 및 규정을 준수할 책임은 사용자에게 있습니다. 이 규정에는 데이터 세트에서 병합을 활성화하기 전에 필요한 최종 사용자 권한을 얻는 것이 포함됩니다."
>additional-url="https://experienceleague.adobe.com/ko/docs/analytics-platform/using/stitching/overview" text="결합 개요"
