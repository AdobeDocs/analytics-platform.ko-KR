...
>title="개인 ID 변경"
>abstract="개인 ID를 변경하면 연결에서 기존 데이터가 모두 삭제되고 새 개인 ID를 기반으로 데이터 세트에서 모든 데이터가 다시 수집됩니다. 이 작업은 비용에 영향을 줄 수 있습니다. <br/><br/>**[!UICONTROL 계속]**&#x200B;을 선택하면 프로세스가 완료될 때까지 보고가 지연될 수 있습니다."
