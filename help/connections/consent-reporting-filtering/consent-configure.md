...
1. **[!UICONTROL 프로필 데이터 세트]** 섹션에서 보고할 동의 정책 구성원 자격 데이터(`consentPoliciesIDMap` 필드)가 포함된 프로필 데이터 세트를 선택합니다. 이 프로필 데이터 세트는 선택한 연결에 추가됩니다.
...
1. (선택 사항) **[!UICONTROL 필터링]** 섹션에서 다음 마케팅 작업에 대해 필터링을 활성화할 수 있습니다.
   ...
   >[!NOTE]
   >
   >필터링하지 않고 동의 보고를 활성화하려면 두 토글을 모두 선택하지 않은 상태로 둡니다.
   >
...
1. 구성을 만들려면 **[!UICONTROL 만들기]**&#x200B;를 선택하십시오.
   ...
   * 데이터 보기에서 필터링할 수 있도록 **동의** 내부 레이블을 새 구성 요소에 적용합니다. 내부 레이블에 대한 자세한 내용은 [레이블 및 정책](/help/data-views/data-governance.md)을 참조하십시오.
