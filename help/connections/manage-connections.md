...
>title="평균 행 크기"
>abstract="현재 월에 대해 수집 및 저장된 각 데이터 행에서 소비한 평균 스토리지 양(KB)이며, 이전 달과 비교하여 백분율이 변경되었습니다."
...
* 표시되는 **[!UICONTROL 주요 사용 지표]** 패널:
   ...
   * 다음에 대한 이전 달의 총 및 백분율 변경 사항을 표시하는 네 가지 요약 시각화:
      ...
      * **[!UICONTROL 평균 행 크기]**. 현재 월에 대해 수집 및 저장된 각 데이터 행에서 소비한 평균 스토리지 양(KB)이며, 이전 달과 비교하여 백분율이 변경되었습니다.
