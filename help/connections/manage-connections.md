...
| **[!UICONTROL 데이터 세트 유형]** | [데이터 집합 형식](create-connection.md#dataset-types)입니다. 유형은 **[!UICONTROL 이벤트]**, **[!UICONTROL 프로필]**, **[!UICONTROL 조회]**, **[!UICONTROL 요약]**&#x200B;일 수 있습니다. 임시 또는 모델 기반 데이터 집합은 **[!UICONTROL (Adhoc)]** 또는 **[!UICONTROL (Model)]**&#x200B;에 의해 식별됩니다. 예: **[!UICONTROL 이벤트(임시)]** 또는 **[!UICONTROL 조회(모델)]**. |
