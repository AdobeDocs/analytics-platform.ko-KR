...
>title="확장된 데이터 용량 행"
>abstract="확장 데이터 용량 행은 집계된 합계가 아닌 스냅샷 값입니다. 이러한 값은 선택한 날짜 범위의 마지막 달을 기준으로 동적으로 업데이트됩니다. 고객이 1월~3월을 선택하는 경우, 값은 3월의 스냅샷을 반영합니다."
...
>title="Content Analytics 핵심 보고 가능한 행"
>abstract="Content Analytics 코어 보고 가능 행은 집계된 합계가 아닌 스냅샷 값입니다. 이러한 값은 선택한 날짜 범위의 마지막 달을 기준으로 동적으로 업데이트됩니다. 고객이 1월~3월을 선택하는 경우, 값은 3월의 스냅샷을 반영합니다."
...
>abstract="핵심 비즈니스 프로필 보고 가능 행은 집계된 합계가 아닌 스냅샷 값입니다. 이러한 값은 선택한 날짜 범위의 마지막 달을 기준으로 동적으로 업데이트됩니다. 고객이 1월~3월을 선택하는 경우, 값은 3월의 스냅샷을 반영합니다."

>[!CONTEXTUALHELP]
>id="connections_breakdown_b2b_historicalreportablebpp"
>title="이전 비즈니스 프로필 보고 가능 행"
>abstract="기록 비즈니스 프로필 보고 가능 행은 합계되지 않은 스냅샷 값입니다. 이러한 값은 선택한 날짜 범위의 마지막 달을 기준으로 동적으로 업데이트됩니다. 고객이 1월~3월을 선택하는 경우, 값은 3월의 스냅샷을 반영합니다."
...
>id="△△ "
>title="월별 미디어 시작"
>abstract="월별 미디어 시작은 집계된 합계가 아닌 스냅샷 값입니다. 이러한 값은 선택한 날짜 범위의 마지막 달을 기준으로 동적으로 업데이트됩니다. 고객이 1월~3월을 선택하는 경우, 값은 3월의 스냅샷을 반영합니다."
