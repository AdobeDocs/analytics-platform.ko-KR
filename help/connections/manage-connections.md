...
>title="핵심 보고 가능 행"
>abstract="핵심 보고 가능 행은 집계된 합계가 아닌 스냅샷 값입니다. 이러한 값은 선택한 날짜 범위의 마지막 달을 기준으로 동적으로 업데이트됩니다. 값은 선택한 월의 스냅샷을 반영합니다."

>[!CONTEXTUALHELP]
>id="connections_breakdown_historicalreportablerows"
>title="내역 보고 가능 행"
>abstract="내역 보고 가능 행은 집계된 합계가 아닌 스냅샷 값입니다. 이러한 값은 선택한 날짜 범위의 마지막 달을 기준으로 동적으로 업데이트됩니다. 값은 선택한 월의 스냅샷을 반영합니다."

>[!CONTEXTUALHELP]
>id="connections_breakdown_cumulativereportablerows"
>title="누적 보고 가능 행"
>abstract="누적 보고 가능 행은 집계된 합계가 아닌 스냅샷 값입니다. 이러한 값은 선택한 날짜 범위의 마지막 달을 기준으로 동적으로 업데이트됩니다. 값은 선택한 월의 스냅샷을 반영합니다."
...
>title="확장된 데이터 용량 행"
>abstract="확장 데이터 용량 행은 집계된 합계가 아닌 스냅샷 값입니다. 이러한 값은 선택한 날짜 범위의 마지막 달을 기준으로 동적으로 업데이트됩니다. 값은 선택한 월의 스냅샷을 반영합니다."

>[!CONTEXTUALHELP]
>id="connections_aca_corereportablerows"
>title="Content Analytics 핵심 보고 가능한 행"
>abstract="지난 13개월 동안 현재 달에 사용할 수 있는 총 Content Analytics 특정 행 수(이전 달 대비 백분율 변경 포함).  예: 2024년 2월 1일의 수는 2023년 1월부터 2024년 1월까지의 이벤트 타임스탬프에서 사용 가능한 합계 행을 보여 줍니다."
...
>title="Content Analytics 핵심 보고 가능한 행"
>abstract="Content Analytics 코어 보고 가능 행은 집계된 합계가 아닌 스냅샷 값입니다. 이러한 값은 선택한 날짜 범위의 마지막 달을 기준으로 동적으로 업데이트됩니다. 값은 선택한 월의 스냅샷을 반영합니다."


>[!CONTEXTUALHELP]
>id="connections_b2b_coreportablebpp"
>title="핵심 비즈니스 사용자 프로필 보고 가능 행"
>abstract="현재 달에 대해 지난 13개월 동안 사용할 수 있고 이전 달과 비교하여 백분율이 변경된 총 비즈니스 프로필 보고 가능 행 수입니다.  예: 2024년 2월 1일의 수는 2023년 1월부터 2024년 1월까지의 이벤트 타임스탬프에서 사용 가능한 합계 행을 보여 줍니다."

>[!CONTEXTUALHELP]
>id="connections_b2b_historicalreportablebpp"
>title="이전 비즈니스 프로필 보고 가능 행"
>abstract="현재 달에 13개월 이상 지난 기간 동안 이전 달과 비교하여 백분율 변경과 함께 사용 가능한 비즈니스 프로필 보고 가능 행의 총 수입니다. 예: 2024년 2월 1일의 수는 2023년 1월 이전 이벤트 타임스탬프에서 사용 가능한 합계 행을 보여 줍니다."

>[!CONTEXTUALHELP]
>id="connections_breakdown_b2b_corereportablebpp"
>title="핵심 비즈니스 프로필 보고 가능 행"
>abstract="핵심 비즈니스 프로필 보고 가능 행은 집계된 합계가 아닌 스냅샷 값입니다. 이러한 값은 선택한 날짜 범위의 마지막 달을 기준으로 동적으로 업데이트됩니다. 값은 선택한 월의 스냅샷을 반영합니다."

>[!CONTEXTUALHELP]
>id="connections_breakdown_b2b_historicalreportablebpp"
>title="이전 비즈니스 프로필 보고 가능 행"
>abstract="기록 비즈니스 프로필 보고 가능 행은 합계되지 않은 스냅샷 값입니다. 이러한 값은 선택한 날짜 범위의 마지막 달을 기준으로 동적으로 업데이트됩니다. 값은 선택한 월의 스냅샷을 반영합니다."

>[!CONTEXTUALHELP]
>id="connections_monthlymediastarts"
>title="월별 미디어 시작"
>abstract="현재 달에 대해 지난 13개월 동안 사용할 수 있는 총 월별 미디어 시작 횟수로, 이전 달과 비교하여 백분율이 변경되었습니다.  예를 들어, 2024년 2월 1일의 숫자는 2023년 1월부터 2024년 1월까지 이벤트 타임스탬프와 함께 사용할 수 있는 총 미디어 시작을 보여줍니다."

>[!CONTEXTUALHELP]
>id="connections_breakdown_monthlymediastarts"
>title="월별 미디어 시작"
>abstract="월별 미디어 시작은 집계된 합계가 아닌 스냅샷 값입니다. 이러한 값은 선택한 날짜 범위의 마지막 달을 기준으로 동적으로 업데이트됩니다. 값은 선택한 월의 스냅샷을 반영합니다."


>[!CONTEXTUALHELP]
>id="connections_breakdown_aca_monthlyreportablerows"
>title="월별 Content Analytics 행"
>abstract="월별 Content Analytics 행은 집계된 합계가 아닌 스냅샷 값입니다. 이러한 값은 선택한 날짜 범위의 마지막 달을 기준으로 동적으로 업데이트됩니다. 값은 선택한 월의 스냅샷을 반영합니다."
