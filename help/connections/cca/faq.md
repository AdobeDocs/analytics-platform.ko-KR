...
다른 지표는 CJA 및 기존 Adobe Analytics와 유사할 수 있습니다. 예를 들어 Adobe Analytics의 총 카운트 [사용자 지정 이벤트](https://experienceleague.adobe.com/docs/analytics/components/metrics/custom-events.html?lang=ko-KR) 1-100은 일반적으로 기존 Adobe Analytics 및 CJA에서 매우 유사해야 합니다(결합했는지 여부에 상관없이). 그러나 다음 이유로 인해 항상 true가 아닐 수 있습니다 [기능 차이점](/help/getting-started/aa-vs-cja/cja-aa.md))를 사용할 수 있습니다.
