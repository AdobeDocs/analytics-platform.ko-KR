...
| **를 사용하십시오 [CJA 주석 API](https://developer.adobe.com/cja-apis/docs/endpoints/annotations/)** | CJA 주석 API를 사용하면 Adobe I/O을 통해 프로그래밍 방식으로 주석을 생성, 업데이트 또는 검색할 수 있습니다. 이러한 API는 Adobe이 제품 UI 내에서 사용하는 것과 동일한 데이터 및 메서드를 사용합니다. |
