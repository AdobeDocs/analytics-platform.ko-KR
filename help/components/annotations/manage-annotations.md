...
주석을 편집한다는 것은 날짜 범위, 색상, 범위 또는 모든 데이터 보기 또는 프로젝트에 적용되는지 여부를 조정할 수 있음을 의미합니다. 다음 두 가지 방법으로 주석을 편집할 수 있습니다.
...
모든 주석은 타임스탬프와 함께 생성되지만 &#39;시간&#39;이나 &#39;시간대&#39; 정보는 포함되지 않습니다. 보고서 시에는 패널 데이터 보기의 시간대가 항상 적용됩니다. 따라서 성탄절을 위해 만든 주석은 사용자가 살고 있는 데이터 보기 시간대에 상관없이 12월 25일에 수행됩니다.
...
| 필터 (왼쪽 레일) | 태그, 데이터 보기, 소유자 및 기타 필터(내 세그먼트, 승인됨, 즐겨찾기, 나와 공유, 모두 표시)로 필터링합니다. |
