...
>[!NOTE]
>
>특정 프로젝트에 대해서만 만든 [!UICONTROL 주석]은 관리자에 표시되지 않습니다.

## 주석 관리자 사용자 인터페이스

![다음 섹션에서 설명하는 공유, 태그 지정, 복사 등의 주석 옵션입니다.](assets/annotation-mgr.png)
...
모든 주석은 타임스탬프와 함께 만들어지지만 &#39;시간&#39;이나 &#39;시간대&#39; 정보는 포함되지 않습니다. 보고 시 패널의 데이터 보기 시간대가 항상 적용됩니다. 따라서 크리스마스에 만든 주석은 데이터 보기 시간대와 관계없이 12월 25일에 표시됩니다.
