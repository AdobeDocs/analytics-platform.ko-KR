...
예를 들어 조직과 프로젝트를 공유한다고 가정해 보겠습니다. 마케팅 캠페인으로 인해 트래픽이 크게 증가한 경우 &quot;캠페인 시작 날짜&quot; 주석을 생성하고 전체 데이터 보기에 대해 범위를 지정할 수 있습니다. 사용자가 해당 날짜를 포함한 데이터 세트를 볼 때 해당 데이터와 함께 프로젝트 내에 주석이 표시됩니다.
...
* 데이터 보기가 생성된 데이터 보기(기본값) 또는 모든 데이터 보기에 적용할 수 있습니다.
