...
1. Analysis Workspace의 왼쪽 패널에서 [!UICONTROL **데이터 사전**] 아이콘을 선택합니다. (데이터 사전에 액세스하는 다른 방법은 [데이터 사전 개요](/help/components/data-dictionary/data-dictionary-overview.md)의 [데이터 사전 액세스](/help/components/data-dictionary/data-dictionary-overview.md#access-the-data-dictionary)에 설명되어 있습니다.)
