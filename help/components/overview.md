...
| 구성 요소 작업 | 설명 |
| --- | --- |
| 태그 | 구성 요소에 태그를 적용하여 구성 요소를 구성하거나 관리합니다. 그런 다음 [!UICONTROL Analytics] > [!UICONTROL 구성 요소] > [!UICONTROL 필터] 또는 [!UICONTROL Analytics] > [!UICONTROL 구성 요소] > [!UICONTROL 프로젝트] 등과 같은 해당 구성 요소 관리자에 표시됩니다. |
| 즐겨찾기 | 구성 요소를 즐겨찾기 목록에 추가합니다. 그런 다음 [!UICONTROL Analytics] > [!UICONTROL 구성 요소] > [!UICONTROL 필터] 또는 [!UICONTROL Analytics] > [!UICONTROL  구성 요소] > [!UICONTROL 프로젝트]와 같은 해당 구성 요소 관리자에 표시됩니다. |
| 승인 | 정형화되도록 구성 요소를 승인합니다. 그런 다음 [!UICONTROL Analytics] > [!UICONTROL 구성 요소] > [!UICONTROL 필터] 또는 [!UICONTROL Analytics] > [!UICONTROL 구성 요소] > [!UICONTROL 프로젝트] 등과 같은 해당 구성 요소 관리자에 표시됩니다. |
| 공유 | 필터에만 적용됩니다. |
| 삭제 | 필터에만 적용됩니다. |

지표, 필터 및 날짜 만들기에 대한 비디오를 보십시오.
