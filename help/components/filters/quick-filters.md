...
## 프로젝트 전용 필터란? {#project-only}

프로젝트 전용 필터는 해당 필터가 작성된 현재 프로젝트에만 적용되는 세그먼트입니다. 다른 프로젝트에서 사용할 수 없으며, 다른 사용자와 공유할 수 없습니다. 프로젝트 전용 필터는 왼쪽 레일에서 세그먼트를 작성하고 저장하지 않고도 데이터를 빠르게 탐색하기 위해 고안되었습니다. [빠른 필터] 또는 [임시 필터](/help/components/filters/ad-hoc-filters.md)를 통해 패널 드롭 영역에서 프로젝트 전용 필터를 작성할 수 있습니다.
