...
필터 관리자는 공유, 태깅, 승인, 복사, 삭제 및 즐겨찾기로 표시 등 다양한 필터 처리 방법을 제공합니다.

필터 관리자는 사용자가 보유하는 모든 필터 및 사용자와 공유되는 모든 필터를 표시합니다. 관리자 수준의 사용자는 조직의 모든 필터를 볼 수 있습니다. 이 개요에서는 필터 관리자의 사용자 인터페이스와 기능을 설명합니다.

위쪽 탐색의 **[!UICONTROL 고객 여정 분석]** > **[!UICONTROL 구성 요소]** > **[!UICONTROL 필터]**&#x200B;로 이동하여 필터 관리자에 액세스합니다.
...
| 14 | 기타 필터 | 태그, 데이터 보기, 소유자 및 기타(모두 표시, 내 세그먼트, 나와 공유됨, 승인됨, 즐겨찾기)별로 필터를 볼 수 있습니다. |

## 플랜 필터

필터를 계획하는 데 시간을 투자하면 해당 필터가 조직에 유용하고 해당 수가 확인될 가능성이 높아집니다.
...
필터 관리자에서 필터에 태깅하여 필터를 구성할 수 있습니다. 모든 사용자는 필터용 태그를 만들고 필터에 하나 이상의 태그를 적용할 수 있습니다. 그렇지만 본인이 소유하거나 본인과 공유된 필터에 대한 태그만 볼 수 있습니다.
...
1. 필터를 태깅하려면 **[!UICONTROL 태그]**&#x200B;를 다시 클릭합니다.
...
1. **[!UICONTROL 비승인]**&#x200B;을 클릭하여 승인된 필터를 승인하지 않을 수도 있습니다.
...
필터를 즐겨찾기로 표시하는 것은 쉽게 사용할 수 있도록 필터를 구성하는 또 다른 방법입니다.
