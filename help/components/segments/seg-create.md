...
* **B**. Workspace 프로젝트의 구성 요소 왼쪽 패널에서 ![세그먼트](/help/assets/icons/Segmentation.svg) **세그먼트**&#x200B;에 있는 ![추가](/help/assets/icons/Add.svg)를 선택합니다.
...
* **E**. Workspace 프로젝트에서 바로 가기 **[!UICONTROL shift+cmd+e]**(macOS) 또는 **[!UICONTROL shift+ctrl+e]**(Windows)를 사용합니다.
* **F**. ***여기에 세그먼트(또는 다른 구성 요소) 놓기***&#x200B;에서 ![추가](/help/assets/icons/Add.svg)를 선택합니다. 이 작업은 프로젝트 전용 세그먼트를 만듭니다.
