...
>title="새로 고침 빈도"
>abstract="대상자의 멤버십이 다시 평가되는 빈도입니다.<br/>일회성 요청은 한 번만 평가되며 새로 고침 제한에 포함되지 않습니다."
...
![이 섹션에 설명된 대상자 게시의 지연.](assets/latency-diagram.png)
...
이러한 측면을 명확하게 구분함으로써 Customer Journey Analytics 및 Real-Time Customer Data Platform의 대상 데이터를 보다 잘 이해하고 관리할 수 있습니다.—>
