...
1. 대상자를 빌드합니다.
   ...
   | [!UICONTROL 새로 고침 빈도] | 대상자를 새로 고침하는 빈도입니다.<ul><li>새로 고침이 필요하지 않은 일회성 대상자(기본값)를 만들도록 선택할 수 있습니다. 이는 예를 들어 특정 일회성 캠페인에 유용합니다.</li><li>다른 새로 고침 주기를 선택할 수 있습니다. 모든 새로 고침 빈도의 경우 CJA 권한에 따라 75~150개의 대상이 있습니다.</li></ul> |
