...
대상자는 **[!UICONTROL 구성 요소]** > **[!UICONTROL 대상자]**&#x200B;를 사용하여 Customer Journey Analytics에서 관리할 수 있습니다.
...
* insight에서 대상을 생성하는 데 걸린 **시간**&#x200B;까지 Customer Journey Analytics을 얻으십시오. 그리고 활성화를 위해 실시간 고객 플랫폼에 대상을 표시하는 데 걸린 시간입니다.
* Customer Journey Analytics의 대상이 **실시간 고객 플랫폼에서 활발히 사용되고 있는지**&#x200B;을(를) 확인하십시오. 또는 (이상적으로) Customer Journey Analytics에서 만든 대상을 소비하는 모든 Experience Platform 애플리케이션입니다.

[대상 보기](/help/technotes/access-control.md#user-level-access) 액세스 권한이 있는 경우 대상을 볼 수 있습니다. [대상자 만들기](/help/technotes/access-control.md#user-level-access) 액세스 권한이 있는 경우 대상자를 편집하고 삭제할 수 있습니다.
...
대상자 목록을 보려면 다음 작업을 수행하십시오.

1. Customer Journey Analytics에서 **[!UICONTROL 구성 요소]** > **[!UICONTROL 대상]**&#x200B;을 선택합니다.

1. (선택 사항) 표시할 열을 구성하려면 ![ColumnSetting](/help/assets/icons/ColumnSetting.svg)을(를) 사용합니다.

1. (선택 사항) ![Search](/help/assets/icons/Search.svg)을(를) 사용하여 대상자를 검색합니다.

   각 대상자에 대한 정보로 사용할 수 있는 열은 다음과 같습니다.
...
언제든지 대상자의 설정을 편집할 수 있습니다. 대상(일회성 대상 또는 반복 대상)을 편집할 때 다시 게시해야 합니다.
...
1. 편집할 대상자의 제목을 선택합니다.

   **[!UICONTROL 대상자 편집]** 대화 상자가 표시됩니다.

1. 대상자에 대해 사용 가능한 필드를 업데이트할 수 있습니다. 업데이트할 수 있는 필드에 대한 자세한 내용은 문서 [대상 만들기 및 게시](/help/components/audiences/publish.md)의 [대상 빌더](/help/components/audiences/publish.md#audience-builder)를 참조하십시오.
...
| ![Delete](/help/assets/icons/Delete.svg) | **[!UICONTROL 삭제]** | 선택한 대상자를 삭제합니다. |
| ![Edit](/help/assets/icons/Edit.svg) | **[!UICONTROL 이름 바꾸기]** | 선택한 대상자의 이름을 변경합니다. **[!UICONTROL 이름 바꾸기: *대상 이름&#x200B;*]**대화 상자를 사용하여 대상 이름을 변경하고**[!UICONTROL 저장&#x200B;]**을 선택하여 저장합니다. |
