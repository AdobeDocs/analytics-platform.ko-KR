...
1. Customer Journey Analytics <!-- add this back in after the other methods are available like in AA and make a bulleted list: "You can access the alert builder in any of the following ways:" -->에서 **[!UICONTROL 구성 요소]** > **[!UICONTROL 경고]**&#x200B;를 선택합니다. [경고 관리자](alert-manager.md)에서 ![AddCircle](/help/assets/icons/AddCircle.svg) **[!UICONTROL 추가]**&#x200B;를 선택하여 새 경고를 만들거나 나열된 경고 중 하나를 선택하여 기존 경고를 수정합니다.
