...
1. (선택사항) 지정된 기간 동안 미래 요청을 제한하려면
   ...
   1. 다음 선택 사항 중 하나를 선택합니다.
      ...
      | 옵션 | 함수 |
      |---------|----------|
      | [!UICONTROL **사용자 및 프로젝트**] | 선택한 요청과 연관된 사용자는 연계된 프로젝트에 대한 보고 요청 실행에서 일시적으로 제한됩니다. |
...
1. (선택사항) 지정된 기간 동안 미래 요청을 제한하려면
   ...
   1. 다음 선택 사항 중 하나를 선택합니다.
      ...
      | [!UICONTROL **프로젝트**] | 선택한 사용자와 연관된 프로젝트는 다른 사용자에 의한 모든 보고 요청에서 제한됩니다. |
      | [!UICONTROL **다음에 대해 제한**] | 요청이 제한되는 기간을 선택합니다. 1분(기본값), 5분, 10분, 15분 또는 30분을 선택할 수 있습니다. <!--double-check this--> <p>제한을 설정한 후에는 조기에 제거할 수 없습니다.</p> |
...
1. (선택사항) 지정된 기간 동안 미래 요청을 제한하려면
   ...
   1. 다음 선택 사항 중 하나를 선택합니다.
      ...
      | 옵션 | 함수 |
      |---------|----------|
      | [!UICONTROL **사용자 및 프로젝트**] | 선택한 프로젝트는 연관된 사용자의 보고 요청에서 일시적으로 제한됩니다.<p>이것은 가장 덜 제한적인 옵션입니다.</p> |
      | [!UICONTROL **사용자**] | 선택한 프로젝트와 연계된 사용자는 모든 보고 요청에서 제한됩니다. |
