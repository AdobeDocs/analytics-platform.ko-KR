...
| 타임스탬프 | ID | pagename | 성격 | trackingcode | 주문 | 수익 금액 |
| :---                      |  ---: | :---              | :---            | :---          |   ---: | :---           |
...
1. **[!UICONTROL 샘플 이벤트 피드 스키마]** 옆에 있는 ![AddCircle](/help/assets/icons/AddCircle.svg)을(를) 선택하여 스키마에 필드를 추가합니다. 데이터 유형 및 추가 속성을 가진 다음 필드를 스키마에 추가합니다.
...
1. **[!UICONTROL 마침]**&#x200B;을 선택합니다. 구성된 데이터 흐름으로 이동합니다.
...
4. **[!UICONTROL 구성 요소]** 단계에서:
   ...
   1. **[!UICONTROL 지표]** 또는 **[!UICONTROL 차원]** 구성 요소 상자에 포함할 스키마 필드 및/또는 표준 구성 요소를 추가합니다. 미러링된 데이터가 포함된 데이터 세트에서 관련 필드를 추가해야 합니다. 이러한 필드에 액세스하려면:
