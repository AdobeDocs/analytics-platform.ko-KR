...
![B2B 스키마에 주석이 추가됨](assets/b2b-schemas-annotated.png)
...
1. 개인 기반 B2B 조회에 대해 변환할 각 조회 데이터 세트에 대해 **[!UICONTROL 데이터 세트 변환]**&#x200B;을 활성화하여 개인 기반 조회에 대해 데이터가 변환되도록 합니다. 자세한 내용은 [B2B 조회를 위한 데이터 세트 변환](/help/connections/transform-datasets-b2b-lookups.md)을 참조하십시오.
   ...
   아래 표는 각 데이터 세트에 대한 [!UICONTROL 개인 ID], [!UICONTROL 키] 및 [!UICONTROL 일치하는 키] 예제 값의 예제 개요를 제공합니다.

   >[!IMPORTANT]
   >
   >아래 표의 **개인 ID**, **키** 및 **일치하는 키**&#x200B;의 값은 **예제 값**&#x200B;이며 특정 환경에서 다를 수 있습니다.
   >


   | 데이터 세트(선택 사항) | 개인 ID | 키<br/> | 일치하는 키 <br/>(이벤트 데이터 세트 내)<br/> |
   |---|---|---|---|
...
>[!IMPORTANT]
>
>아래 표의 지표 및 값(**구성 요소 이름**, **데이터 세트**, **데이터 세트 유형** 및 **[!UICONTROL 스키마 경로])**&#x200B;은 **예**&#x200B;입니다. 특정 상황에 적절한 B2B 지표(구성 요소 이름, 데이터 세트, 데이터 유형 및 스키마 경로)를 정의합니다.
>

| 구성 요소 이름 | 데이터 세트 | 데이터 유형 | 스키마 경로 |
|---|---|---|---|
| 연간 계정 수익 | B2B 계정 데이터 세트 | 더블 | accountOrganization.annualRevenue.amount |
| 직원 수 | B2B 계정 데이터 세트 | 정수 | accountOrganization.numberOfEmployees |
| 실제 캠페인 비용 | B2B 캠페인 데이터 세트 | 더블 | actualCost.mount |
| 예산 캠페인 비용 | B2B 캠페인 데이터 세트 | 더블 | budgetedCost.amount |
| 예상 영업 기회 수익 | B2B 영업 기회 데이터 세트 | 더블 | expectedRevenue.mount |
| 예상 캠페인 수익 | B2B 캠페인 데이터 세트 | 더블 | expectedRevenue.mount |
| 영업 기회 금액 | B2B 영업 기회 데이터 세트 | 더블 | opportunityMount.amount |
...
>[!IMPORTANT]
>
>아래 표의 차원 및 값(**구성 요소 이름**, **데이터 세트**, **데이터 세트 유형** 및 **[!UICONTROL 스키마 경로])**&#x200B;은 **예**&#x200B;입니다. 특정 상황에 적절한 B2B 차원(구성 요소 이름, 데이터 세트, 데이터 유형 및 스키마 경로)을 정의합니다.
>
...
| 기회 이름 | B2B 영업 기회 데이터 세트 | 문자열 | opportunityName |
