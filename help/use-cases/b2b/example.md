...
다음을 참조하십시오 [데이터 세트 추가 및 구성](../../connections/create-connection.md) 데이터 세트에 대한 설정을 구성하는 방법에 대한 자세한 내용을 보려면 를 참조하십시오.
...
각 구성 요소에 대해 이름, 스키마 경로 및 (해당되는 경우) 구성에 대한 세부 정보가 제공됩니다.


### B2B 활동 데이터 세트

B2B 활동 데이터 세트에는 관련 경험 이벤트가 포함되어 있으며 연결의 일부로 필요합니다.
...
B2B 개인 데이터 세트에는 관련 프로필이 포함되어 있습니다.
...
B2B Opportunity 데이터 세트에는 관련 Opportunity 가 포함되어 있습니다.
...
B2B 캠페인 데이터 세트에는 캠페인 데이터가 포함되어 있습니다.
...
B2B 계정 데이터 세트에는 계정 데이터가 포함되어 있습니다.
...
B2B 캠페인 멤버 데이터 세트에는 캠페인 멤버의 상호 작용이 포함됩니다.
