...
| 실제 캠페인 비용 | B2B 캠페인 데이터 세트 | 더블 | actualCost.amount |
| 예산 캠페인 비용 | B2B 캠페인 데이터 세트 | 더블 | budgetedCost.amount |
| 예상 영업 기회 수익 | B2B 영업 기회 데이터 세트 | 더블 | expectedRevenue.amount |
| 예상 캠페인 수익 | B2B 캠페인 데이터 세트 | 더블 | expectedRevenue.amount |
| 영업 기회 금액 | B2B 영업 기회 데이터 세트 | 더블 | opportunityAmount.amount |
