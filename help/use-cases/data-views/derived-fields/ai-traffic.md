...
[파생 필드](#derived-fields), [세그먼트](#segments) 및 [작업 영역 프로젝트](#workspace-project)의 특정 설정 및 구성을 통해 일반적인 Customer Journey Analytics 설정([연결](/help/connections/overview.md), [데이터 보기](/help/data-views/data-views.md) 및 [작업 영역 프로젝트](/help/analysis-workspace/home.md)) 내에서 LLM 및 AI가 생성한 트래픽을 보고할 수 있습니다.
