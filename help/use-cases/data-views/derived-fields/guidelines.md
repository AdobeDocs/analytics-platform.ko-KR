...
* 조회 데이터 세트를 사용합니다. 많은 **[!UICONTROL If 값 _값_ 기준 _기준_ Then _값_을(를) 값]**(으)로 설정하는 것이 긴 [Case When](/help/data-views/derived-fields/derived-fields.md#case-when) 체인을 사용하는 대신 [Lookup](/help/data-views/derived-fields/derived-fields.md#lookup) 함수와 결합된 [조회 데이터 세트](/help/getting-started/cja-upgrade/cja-upgrade-dataset-lookup.md)(으)로 더 잘 구현됩니다.
...
* 대문자나 소문자를 유지하는 이유가 문서화되어 있지 않은 한 [Lookup](/help/data-views/derived-fields/derived-fields.md#lookup) 함수 앞에 [Lowercase](/help/data-views/derived-fields/derived-fields.md#lowercase) 및 [Trim](/help/data-views/derived-fields/derived-fields.md#trim) 함수를 추가하십시오.
...
* [Regex 바꾸기](/help/data-views/derived-fields/derived-fields.md#regex-replace) 또는 regex 기반 조건에서는 광범위한 패턴을 사용합니다. **[!UICONTROL 포함]** 또는 **[!UICONTROL 다음으로 시작]**&#x200B;을 사용하는 간단한 [경우](/help/data-views/derived-fields/derived-fields.md#case-when)이(가) 더 나은 대안입니다.
...
* [Regex 바꾸기](/help/data-views/derived-fields/derived-fields.md#regex-replace)보다 표준 URL 요소(도메인, 경로, 쿼리 매개 변수)에 대해 [URL 구문 분석](/help/data-views/derived-fields/derived-fields.md#url-parse)을 선호합니다.
* 간단한 패턴 검사의 경우 [Regex Replace](/help/data-views/derived-fields/derived-fields.md#regex-replace)를 사용하는 정규 표현식 대신 [Case When](/help/data-views/derived-fields/derived-fields.md#case-when) with **[!UICONTROL Contains]**, **[!UICONTROL Starts with]** 또는 **[!UICONTROL Ends with]** 논리를 사용하십시오.
...
* 표준 지속성과 유사한 패턴(예: 세션 또는 사용자 간에 값을 전달)의 경우, [다음 또는 이전](/help/data-views/derived-fields/derived-fields.md#next-or-previous)으로 이러한 패턴을 시뮬레이션하는 대신 데이터 보기에서 차원의 [지속성](/help/data-views/component-settings/persistence.md) 설정(**[!UICONTROL 할당 모델]** 및 **[!UICONTROL 만료]**)을 사용하십시오.
...
* 이름과 동작을 맞추려면 차원의 [지속성](/help/data-views/component-settings/persistence.md) 설정에서 **[!UICONTROL 할당 모델]** 및 **[!UICONTROL 만료]**&#x200B;을(를) 조정하십시오. 예를 들어 `Original Source`은(는) **[!UICONTROL 할당 모델]**&#x200B;을(를) **[!UICONTROL 원래]**(으)로 설정해야 합니다. **[!UICONTROL 만료]**&#x200B;은(는) **[!UICONTROL 개인]**(으)로 설정되어 있습니다.
