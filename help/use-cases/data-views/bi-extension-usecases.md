...
1. [변형](#object-transformations).
1. [시각화](#visualizations).

첫 번째 사용 사례는 Customer Journey Analytics BI 확장을 사용하여 BI 도구를 연결하는 방법에 중점을 둡니다. 그 밖의 모든 사용 사례에서는 현재 지원되는 BI 도구에서 유사한 Customer Journey Analytics 시각화를 수행하는 방법에 대한 지침을 사용할 수 있습니다.

* Power BI 데스크탑. 사용된 버전은 2.137.1102.0 64비트(2024년 10월)입니다.
...
지침을 따라 예제 객체를 특정 환경에 적합한 객체로 교체합니다.
...
1. 하단의 **[!UICONTROL 시트 1]** 탭을 선택하여 **[!UICONTROL 데이터 원본]** 보기에서 전환하십시오. **[!UICONTROL 시트 1]** 보기에서:
   ...
   1. **[!UICONTROL 필터 \[날짜 범위]]** 대화 상자에서 **[!UICONTROL 날짜 범위]**&#x200B;를 선택하고 `01/01/2023` - `31/01/2023` 기간을 지정하십시오.
...
1. **[!UICONTROL 데이터]** 창:
   ...
   선택한 요소의 열 머리글만 표시하는 빈 테이블이 표시됩니다. 더 나은 가시성을 위해 테이블 시각화를 확대하십시오.
...
1. 시각화 창의 라인 y축으로 구매를 드래그하여 놓습니다.
...
1. 하단의 **[!UICONTROL 시트 1]** 탭을 선택하여 **[!UICONTROL 데이터 원본]**&#x200B;에서 전환하세요. **[!UICONTROL 시트 1]** 보기에서:
   ...
   1. **[!UICONTROL 데이터]** 창의 **[!UICONTROL 테이블(*측정값 이름*)]** 목록에서 **[!UICONTROL 구매]**&#x200B;를 끌어다 놓고 **[!UICONTROL 행]** 옆에 있는 필드에 항목을 놓습니다.
      * 값이 **[!UICONTROL SUM(구매)]**(으)로 자동 변환됩니다.
   1. **[!UICONTROL 데이터]** 창의 **[!UICONTROL 테이블(*측정값 이름*)]** 목록에서 **[!UICONTROL 구매 매출]**&#x200B;을(를) 끌어다 놓고 **[!UICONTROL 열]** 옆의 필드에 항목을 끌어다 놓고 **[!UICONTROL SUM(구매)]**&#x200B;에서 왼쪽으로 놓습니다.
      * 이 값은 **[!UICONTROL SUM(구매 매출)]**(으)로 자동 변환됩니다.
   1. 두 차트를 내림차순 구매 매출 순서로 정렬하려면 구매 매출 제목 위로 마우스를 가져간 다음 정렬 아이콘을 선택합니다.
   1. 차트의 항목 수를 제한하려면 행에서 SUM(Purchase Revenue)을 선택하고 드롭다운 메뉴에서 필터를 선택합니다.
...
1. 테이블에 표시되는 제품 수를 제한하려면 **[!UICONTROL 필터]** 창에서 **[!UICONTROL product_name is (All)]**&#x200B;을(를) 선택하십시오.
   ...
   1. **[!UICONTROL 데이터]** 창에서 **[!UICONTROL 여기에 데이터 필드 추가]**(으)로 **[!UICONTROL 구매]**e를 드래그합니다.
   1. **[!UICONTROL 필터 적용]**&#x200B;을 선택하십시오.
...
1. **[!UICONTROL 새 대시보드]** 탭 단추(맨 아래)를 선택하여 새 **[!UICONTROL 대시보드 1]** 보기를 만듭니다. **[!UICONTROL 대시보드 1]** 보기에서:
   ...
   1. **[!UICONTROL 트리맵]** 시트를 **[!UICONTROL Category]** 시트 아래의 **[!UICONTROL Sheets]** 셸프에서 **[!UICONTROL 대시보드 1]** 보기로 끌어다 놓습니다.
   1. **[!UICONTROL 트리맵]** 시트 아래의 **[!UICONTROL 시트]** 셸프에서 **[!UICONTROL 데이터]** 시트를 **[!UICONTROL 대시보드 1]** 보기로 끌어다 놓습니다.
...
2023년 1월 중에 보고된 고유한 제품 이름을 가져오려고 합니다.
...
1. 날짜 범위가 모든 시각화에 적용되도록 하려면 **[!UICONTROL daterangeday]**&#x200B;을(를) **[!UICONTROL 데이터]** 창에서 이 페이지의 **[!UICONTROL 필터]**(으)로 끌어서 놓습니다.
   1. **[!UICONTROL 이 페이지의 필터]**&#x200B;에서 **[!UICONTROL 날짜 범위는 (모두)]**&#x200B;입니다.
   1. **[!UICONTROL RelAdvanced 필터링]**&#x200B;을(를) **[!UICONTROL 필터 형식]**(으)로 선택합니다.
   1. **[!UICONTROL 값이]** **[!UICONTROL 이거나]** `1/1/2023` **[!UICONTROL 이거나]** **[!UICONTROL 이(가)]** `2/1/2023` 이전인 경우 항목 표시로 필터를 정의합니다.
   1. **[!UICONTROL 필터 적용]**&#x200B;을 선택하십시오.
...
1. **[!UICONTROL ctrl-v]** 키를 사용하여 시각화를 붙여 넣습니다. 시각화의 정확한 복사본이 원래 복사본과 겹칩니다. 보고서 영역에서 오른쪽으로 이동합니다.
...
1. **[!UICONTROL 새 대시보드]** 탭 단추(맨 아래)를 선택하여 새 **[!UICONTROL 대시보드 1]** 보기를 만듭니다. **[!UICONTROL 대시보드 1]** 보기에서:
   ...
   1. **[!UICONTROL 카드]** 시트 아래의 **[!UICONTROL 시트]** 셸프에서 **[!UICONTROL 데이터]** 시트를 **[!UICONTROL 대시보드 1]** 보기로 끌어다 놓습니다.
...
Customer Journey Analytics에서 정의한 날짜 범위를 사용하여 지난 해 동안의 발생 횟수(이벤트)를 필터링하고 보고하려는 경우
...
1. 하단의 **[!UICONTROL 시트 1]** 탭을 선택하여 **[!UICONTROL 데이터 원본]**&#x200B;에서 전환하세요. **[!UICONTROL 시트 1]** 보기에서:
   ...
   1. **[!UICONTROL Daterangemonth]** 항목을 **[!UICONTROL 테이블]** 목록에서 **[!UICONTROL 행]**(으)로 끌어옵니다. **[!UICONTROL Daterangemonth]**&#x200B;을(를) 선택하고 **[!UICONTROL 월]**&#x200B;을(를) 선택합니다. 값이 **[!UICONTROL MONTH(Daterangemonth)]**(으)로 변경됩니다.
   1. **[!UICONTROL 테이블]** 목록에서 **[!UICONTROL 발생 횟수]** 항목을 **[!UICONTROL 열]**(으)로 끌어옵니다. 값이 **[!UICONTROL SUM(발생 횟수)]**(으)로 변경됩니다.
...
Customer Journey Analytics에서 정의한 Fishing 제품 범주에 대한 기존 필터를 사용하여 2023년 1월 동안 제품 이름과 발생 횟수(이벤트)를 필터링하고 보고하려고 합니다.
...
1. **[!UICONTROL 데이터 Source]** 보기의 **[!UICONTROL 데이터]** 아래에서 **[!UICONTROL cc_data_view(prod:cja%3FFLATTEN)]**&#x200B;의 컨텍스트 메뉴에서 **[!UICONTROL 새로 고침]**&#x200B;을 선택합니다.
1. 하단의 **[!UICONTROL 시트 1]** 탭을 선택하여 **[!UICONTROL 데이터 원본]**&#x200B;에서 전환하세요. **[!UICONTROL 시트 1]** 보기에서:
   1. **[!UICONTROL 필터]** 셸프의 **[!UICONTROL 테이블]** 목록에서 **[!UICONTROL 필터 이름]** 항목을 드래그합니다.
...
2023년 1월 동안의 제품 이름에 대한 구매 매출 및 구매를 내림차순 구매 매출 순서로 보고하려고 합니다.
...
1. 시각화 창에서 다음을 수행합니다.
   ...
   1. purchase_revenue의 합계를 열 항목의 맨 아래로 드래그합니다.

1. 보고서에서 purchase_revenue의 합계 를 선택하여 구매 매출의 내림차순으로 테이블을 정렬합니다.

   Power BI 데스크톱은 다음과 같아야 합니다.

   ![필터링할 날짜 범위 이름을 사용하는 Power BI 데스크톱](assets/uc11-powerbi-final.png)

BI 확장을 사용하여 Power BI 데스크톱에서 실행한 쿼리에 `sort` 문이 포함되어 있지 않습니다. `sort` 문이 없다는 것은 내림차순으로 정렬하는 것이 클라이언트 기반임을 의미합니다.
...
1. 하단의 **[!UICONTROL 시트 1]** 탭을 선택하여 **[!UICONTROL 데이터 원본]**&#x200B;에서 전환하세요. **[!UICONTROL 시트 1]** 보기에서:
   ...
   1. **[!UICONTROL 필터 \[날짜 범위]]** 대화 상자에서 **[!UICONTROL 날짜 범위]**&#x200B;를 선택하고 `01/01/2023` - `1/2/2023`을(를) 선택합니다. **[!UICONTROL 적용]** 및 **[!UICONTROL 확인]**&#x200B;을 선택합니다.
   1. **[!UICONTROL 테이블]** 목록에서 **[!UICONTROL 제품 이름]**&#x200B;을(를) **[!UICONTROL 행]**(으)로 드래그합니다.
   1. **[!UICONTROL 테이블]** 목록에서 **[!UICONTROL 구매]** 항목을 **[!UICONTROL 열]**(으)로 끌어옵니다. 값이 **[!UICONTROL SUM(구매)]**(으)로 변경됩니다.
   1. **[!UICONTROL 구매 매출]** 항목을 **[!UICONTROL 테이블]** 목록에서 **[!UICONTROL SUM(구매)]** 옆의 **[!UICONTROL 열]**(으)로 끌어옵니다. 값이 **[!UICONTROL SUM(구매 매출)]**(으)로 변경됩니다.
   1. **[!UICONTROL 표시]**&#x200B;에서 **[!UICONTROL 텍스트 테이블]**&#x200B;을(를) 선택하십시오.
   1. **[!UICONTROL 맞춤]** 드롭다운 메뉴에서 **[!UICONTROL 맞춤]**&#x200B;을 선택합니다.
...
Tableau Desktop에서 BI 확장을 사용하여 실행한 쿼리에 `sort` 문이 포함되어 있지 않습니다. 이 `sort` 문이 없으면 내림차순으로 정렬하는 것이 클라이언트 기반임을 의미합니다.
...
2023년 동안 제품 이름의 상위 5개 발생을 보고하려고 합니다.
...
1. **[!UICONTROL 필터]** 창:
   ...
   1. **[!UICONTROL 값이 마지막]** `1` **[!UICONTROL 역년]**&#x200B;에 있을 때 ]****[!UICONTROL &#x200B;항목을 표시하도록 필터를 정의합니다.
   1. **[!UICONTROL 필터 적용]**&#x200B;을 선택하십시오.
   1. 이 시각적 개체의 **[!UICONTROL 필터에서 product_name이 (모두)임을 선택하십시오]**.
...
BI 확장을 사용하여 Power BI Desktop에서 실행되는 쿼리에 `limit` 문이 포함되어 있지만 필요한 문이 포함되어 있지 않습니다. 클라이언트가 반환한 명시적 제품 이름 결과는 상위 5회 발생에 대한 제한을 암시적으로 적용합니다.
...
1. 하단의 **[!UICONTROL 시트 1]** 탭을 선택하여 **[!UICONTROL 데이터 원본]**&#x200B;에서 전환하세요. **[!UICONTROL 시트 1]** 보기에서:
   ...
   1. **[!UICONTROL 표시]**&#x200B;에서 **[!UICONTROL 텍스트 테이블]**&#x200B;을(를) 선택하십시오.
   1. **[!UICONTROL 맞춤]** 드롭다운 메뉴에서 **[!UICONTROL 맞춤]**&#x200B;을 선택합니다.
   1. 행에서 제품 이름을 선택합니다. 드롭다운 메뉴에서 필터 를 선택합니다.
      ...
      1. **[!UICONTROL 적용]** 및 **[!UICONTROL 확인]**&#x200B;을 선택합니다.
         ...
         테이블이 사라지는 것을 볼 수 있습니다. 발생 횟수별로 상위 5개의 제품 이름을 선택하는 것은 이 필터를 사용하는 경우 제대로 작동하지 않습니다.
...
제품 이름에 대한 상위 5개 발생 횟수 필터를 정의할 때 BI 확장 기능을 사용하여 Tableau Desktop에서 실행하는 쿼리가 아래에 표시됩니다.
...
발생 횟수에 대해 상위 5개 필터를 정의할 때 BI 확장 기능을 사용하여 Tableau Desktop에서 실행하는 쿼리가 아래에 표시됩니다. 이 제한은 쿼리에 표시되지 않고 클라이언트 수준에서만 적용됩니다.
...
BI 확장을 사용하여 Customer Journey Analytics에 연결할 때 데이터베이스에 대해 추가 `FLATTEN` 매개 변수를 사용해야 하는지 여부를 알고 싶습니다.
...
>[!PREREQUISITES]
>
>[성공적인 연결을 확인했는지 확인하고 이 사용 사례를 시도하려는 BI 도구에 대한 데이터 보기를 나열](#connect-and-list-data-views)할 수 있습니다. 올바른 연결에 필요한 명시적 `FLATTEN` 매개 변수 옵션에 대해서는 BI 도구 섹션을 참조하십시오.
>
...
**계산된 지표**
Customer Journey Analytics에서 정의한 계산된 지표는 계산된 지표에 대해 정의한 [!UICONTROL 외부 ID]로 식별됩니다. 예를 들어 계산된 지표 **[!UICONTROL 제품 이름(고유 개수)]**&#x200B;에는 [!UICONTROL 외부 ID] **[!UICONTROL product_name_count_distinct]**&#x200B;가 있으며 Power BI 데스크톱에서는 **[!UICONTROL cm_product_name_count_distinct]**t로 표시됩니다.
...
**[!UICONTROL 일]**, **[!UICONTROL 주]**, **[!UICONTROL 월]** 등과 같은 Customer Journey Analytics의 날짜 범위 차원은 **[!UICONTROL Daterangeday]**, **[!UICONTROL Daterangeweek]**, **[!UICONTROL Daterangemonth]** 등으로 사용할 수 있습니다.
...
이 사용 사례에서는 BI 도구의 사용 가능한 시각화를 사용하여 Customer Journey Analytics에서 사용할 수 있는 시각화를 유사하게 만드는 방법을 이해하려고 합니다.
...
다음 Customer Journey Analytics 시각화는 Power BI 데스크톱에서 사용할 수 있는 유사한 경험에 있습니다.
...
다음 Customer Journey Analytics 시각화는 Tableau에서 사용할 수 있는 것과 유사한 환경에 있습니다.
