...
| _ID | campaign_name | 비용 | 노출 횟수 | campaign_id | network | ad_group | 타임스탬프 |
|---|---|---:|---:|---|---|---|---|
...
[![DataDownload](/help/assets/icons/DataDownload.svg) 샘플 요약 데이터 다운로드](./assets/summary-data.csv)
...
| 타임스탬프 | _ID | page_name | person_id | tracking_code | 주문 | revenue_mount |
|---|---:|---|---|---|---:|---:|
...
[![DataDownload](/help/assets/icons/DataDownload.svg) 샘플 이벤트 데이터 다운로드](./assets/event-data.csv)
...
1. ![앱](/help/assets/icons/Apps.svg) 앱 전환기에서 **[!UICONTROL Experience Platform]**&#x200B;을(를) 선택합니다.
...
1. ![앱](/help/assets/icons/Apps.svg) 앱 전환기에서 **[!UICONTROL Customer Journey Analytics]**&#x200B;을(를) 선택합니다.
   ...
   1. **[!UICONTROL 데이터 보기]** > **[!UICONTROL 요약 데이터를 사용한 데이터 보기]**&#x200B;의 **[!UICONTROL 구성 요소]** 단계에서:
      ...
      1. **[!UICONTROL 지표]** 목록에서 **[!UICONTROL 매출]** 지표를 선택합니다. 구성 요소 패널에서 다음을 수행합니다.
         ...
         1. ![V자형 화살표](/help/assets/icons/ChevronDown.svg) **[!UICONTROL 속성]**&#x200B;을 펼칩니다.
            1. **[!UICONTROL 속성 모델]** 드롭다운 메뉴에서 ![AttributeLastTouch](/help/assets/icons/AttributeLastTouch.svg) **[!UICONTROL 마지막 터치]**&#x200B;를 선택합니다.
...
1. **[!UICONTROL 지표]**&#x200B;에서 **[!UICONTROL 노출 수]**&#x200B;을(를) 끌어다 놓고 지표를 끌어 자유 형식 테이블에 추가 열로 추가하십시오.
1. **[!UICONTROL 지표]**&#x200B;에서 **[!UICONTROL 비용]**&#x200B;을(를) 끌어다 놓고 지표를 끌어 자유 형식 테이블에 추가 열로 추가합니다.
...
1. 새 계산된 지표를 추가하려면 ![AddCircle](/help/assets/icons/AddCircle.svg) **[!UICONTROL Add]**&#x200B;을(를) 선택하십시오.
   ...
   1. ![이벤트](/help/assets/icons/Event.svg) **[!UICONTROL 비용]** **[!UICONTROL ÷]** **[!UICONTROL 노출 수]**&#x200B;를 **[!UICONTROL 정의]**(으)로 사용합니다.
   1. **[!UICONTROL 저장]**&#x200B;을 선택합니다.
1. 다른 새 계산된 지표를 추가하려면 ![AddCircle](/help/assets/icons/AddCircle.svg) **[!UICONTROL Add]**&#x200B;을(를) 선택하십시오.
   ...
   1. ![이벤트](/help/assets/icons/Event.svg) **[!UICONTROL 매출 사용(마지막 터치 | 30일)]** **[!UICONTROL −]** ![이벤트](/help/assets/icons/Event.svg) **[!UICONTROL 비용]**(**[!UICONTROL 정의]**).
   1. **[!UICONTROL 저장]**&#x200B;을 선택합니다.
