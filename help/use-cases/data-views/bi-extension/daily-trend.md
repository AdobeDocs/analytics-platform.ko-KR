---
title: 일별 트렌드
description: Customer Journey Analytics의 다양한 BI 도구의 BI 확장에 대한 일일 트렌드 사용 사례
...
>[!PREREQUISITES]
>
>[성공적인 연결의 유효성을 검사했는지 확인하고 이 사용 사례를 시도하려는 BI 도구에 대해 데이터 보기를 나열하고 사용](connect-and-validate.md)할 수 있습니다.
>
