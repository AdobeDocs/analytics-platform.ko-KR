---
title: 세그먼트에 세그먼트 이름 사용
description: Customer Journey Analytics의 다양한 BI 도구에서 세그먼트 이름을 사용하여 BI 확장 사용 사례를 세그먼트화합니다
...
1. 새 청크에 다음 코드 블록을 입력합니다. 적절한 필터 이름을 사용해야 합니다. (예: `Fishing Products`)
