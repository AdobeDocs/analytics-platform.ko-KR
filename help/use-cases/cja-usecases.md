---
title: Customer Journey Analytics 사용 사례
description: Customer Journey Analytics 사용 사례에 대해 알아보기
...
* **데이터 조작을 통해 정확하게 제어**: 업로드한 데이터를 변경하고, 새 데이터 세트를 만들고, 이를 Analysis Workspace로 가져옵니다. Adobe Experience Platform은 Experience Platform 쿼리 서비스 및 BI 확장 기능을 통해 쿼리, 추출, 변환 및 로드 도구를 제공합니다.
