...
차원을 어떤 지표와 결합할 수 있으므로 다음 표는 데이터가 지정되지 않은 차원 항목을 어떻게 사용하는지 보여줍니다.
...
제품 주문은 여기에 연결된 보증 이름 없이 존재하므로 차원 항목 속성은 &#39;지정되지 않음&#39;으로 설정됩니다. 제품 보증 주문에도 동일한 상황이 적용됩니다.
...
연결된 이름이 없는 주문에 주의하십시오. &#39;지정되지 않음&#39; 차원 항목에 속하는 주문입니다.
