...
일부 플랫폼 스키마에 개체 배열이 있을 수 있습니다. CJA에서는 이벤트, 조회 및 프로필 데이터 내의 개체 배열 수집 및 보고를 지원합니다. 가장 일반적인 예 중 하나는 여러 제품이 포함된 장바구니입니다. 각 제품에는 이름, SKU, 카테고리, 가격, 수량 및 추적하려는 기타 모든 차원이 있습니다. 이러한 모든 패싯에는 별도의 요구 사항이 있지만 모두 동일한 히트에 적합해야 합니다.
