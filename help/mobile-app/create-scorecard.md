...
1. 스코어카드에 새 타일을 추가하려면 왼쪽 패널의 지표를 **[!UICONTROL 여기에 지표 끌어다 놓기]** 영역. 비슷한 작업 과정을 사용하여 두 타일 사이에 지표를 삽입할 수도 있습니다.
...
스코어카드의 모든 타일에 필터를 적용하려면 스코어카드의 맨 위에 타일을 놓습니다. 또는 날짜 범위 아래의 필터 메뉴에서 필터를 선택하여 필터를 적용할 수도 있습니다. 사용자 [스코어카드에 필터 구성 및 적용](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/using-panels/using-drop-down-filters.html?lang=ko-KR) Adobe Analytics Workspace에서와 동일한 방식으로 작업을 수행할 수 있습니다.
...
스코어카드 빌더에서 타일을 클릭하면 오른쪽 레일에 해당 타일과 연관된 속성 및 특성과 세부 슬라이드가 표시됩니다. 이 레일에서 타일에 대한 새 **제목**&#x200B;을 입력하고 필터를 적용하여 타일을 구성할 수 있습니다. 세그먼트는 CJA의 필터입니다.
...
1. 에서 **[!UICONTROL 모바일 스코어카드 공유]** 양식을 작성하여 다음 방법으로 필드를 작성합니다.
...
공유 가능한 링크를 사용하면 이메일, 문서 또는 텍스트 메시지 앱에서 스코어카드를 쉽게 공유할 수 있습니다. 공유 가능한 링크를 사용하면 수신자가 데스크탑 또는 대시보드 모바일 앱에서 스코어카드를 열 수 있습니다. 공유 가능한 심층 연결을 통해 프로젝트를 보다 쉽게 공유하고 이해 관계자와 참여하는 데 도움이 됩니다.
...
1. 링크를 복사하여 이메일, 문서 또는 IM 앱에 붙여넣습니다.
   ...
   수신자가 데스크탑 앱 또는 브라우저를 사용하여 링크를 열면 모바일 스코어카드 프로젝트가 Workspace에서 열립니다.

   수신자가 모바일 장치에서 링크를 열면 Analytics 대시보드 앱에서 바로 스코어카드가 열립니다.

   수신자가 모바일 앱을 다운로드하지 않은 경우 다운로드할 수 있는 App Store 또는 Google Play 스토어의 앱 목록으로 이동됩니다.
