...
Customer Journey Analytics은 Experience Platform 프로필 데이터 세트의 동의 정책 멤버십 데이터를 사용하여 방문자 동의를 보고하고, 선택적으로 데이터가 수집되기 전에 동의하지 않는 방문자를 제외할 수 있습니다. 동의 보고는 Analysis Workspace에서 동의 정책을 구성 요소로 사용할 수 있도록 하며, 동의 필터링은 사용자가 구성하는 마케팅 작업을 기반으로 수집 시 동의하지 않는 방문자를 제외합니다.

[자세히 알아보기](/help/connections/consent-reporting-filtering/consent-overview.md)
