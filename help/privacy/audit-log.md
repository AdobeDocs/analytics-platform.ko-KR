...
| 구성 요소 유형 | 가능한 구성 요소 유형은 다음과 같습니다. <ul><li>주석</li><li>대상자</li><li>계산된 지표</li><li>연결</li><li>데이터 그룹</li><li>데이터 보기 (이 구성 요소 유형에는 차원 및 지표가 포함됩니다.)</li><li>기능 액세스</li><li>필터</li><li>IMS 조직</li><li>모바일</li><li>프로젝트</li><li>보고서</li><li>예약된 프로젝트</li><li>사용자</li><li>사용자 그룹</li></ul> |
