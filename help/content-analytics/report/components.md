...
| 자산 이름 | 에셋 이름. | 차원 | \| 표시 값 없음<br/>가장 최근 \| 세션 |
| 자산 유형 | 에셋 유형. | 차원 | \| 표시 값 없음<br/>가장 최근 \| 세션 |
| 자산 썸네일 URL | 에셋 썸네일용 URL | 차원 | \| 표시 값 없음<br/>가장 최근 \| 세션 |
...
| 자산 생성자 | 자산 만들기용 식별자. | 차원 | \| 표시 값 없음<br/>가장 최근 \| 세션 |
