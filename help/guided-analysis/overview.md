...
| ![ConversionTrens](/help/assets/icons/ConversionTrends.svg) | [전환 추세](types/conversion-trends.md) | 시간 경과에 따른 전환율 변화를 추적합니다. |
...
| 인터페이스 미리보기 | UI 요소 | 설명 |
| --- | --- | --- |
| ![Query rail](assets/query-rail.png){style="border:1px solid gray"} | **[!UICONTROL Query rail]** | 분석을 구성하는 원하는 구성 요소(이벤트, 속성 및 세그먼트)를 선택하여 *질문*&#x200B;을 구성하십시오. 다음 옵션은 모든 분석에서 사용할 수 있으며, 뷰별로 추가 설정을 사용할 수 있습니다. <ul><li>**보기**: 새 분석으로 전환하려면 옵션에서 선택하십시오. 쿼리 선택 사항은 새 분석에 대해 허용된 제한 내에서 유지됩니다.</li><li>**이벤트**: 측정하려는 이벤트입니다. 각 분석에서는 구성할 수 있는 이벤트 수에 대해 서로 다른 제한을 적용합니다.  이벤트에는 **[!UICONTROL 시작 및 반환 이벤트]**, **[!UICONTROL 단계]** 또는 **[!UICONTROL 주요 지표]** 레이블이 지정됩니다. 이벤트는 분석에서 1, 2, ...<br/>새 이벤트를 추가하려면 ![추가](/help/assets/icons/Add.svg) **[!UICONTROL 이벤트 추가]**&#x200B;를 선택합니다.</li><li>**[!UICONTROL 요소]**: 사용 가능한 경우 다음 이후 날짜 및 첫 번째 이벤트와 같은 요소를 지정할 수 있습니다.</li><li>**다음 값으로 계산**: 선택한 이벤트에 적용할 계산 메서드입니다. 드롭다운 메뉴에서 을(를) 선택합니다.</li><li>**세그먼트**: 측정하려는 세그먼트입니다. 각 분석에서는 구성할 수 있는 세그먼트 수에 대해 서로 다른 제한을 적용합니다. 세그먼트는 분석에서 A, B, ...<br/>새 세그먼트를 추가하려면 ![추가](/help/assets/icons/Add.svg) **[!UICONTROL 세그먼트 추가]**&#x200B;를 선택합니다.</li><li>**[!UICONTROL 분류]**: 사용 가능한 경우 분석에 적용할 분류입니다.</li></ul>일부 설정에서는 추가 구성을 사용할 수 있습니다.<ul><li>**필터**: ![필터](assets/filter.png)를 사용하여 특정 차원별로 이벤트 또는 세그먼트 범위를 좁힙니다. 치수를 선택하면 두 표준 필터 조건(예: **[!UICONTROL 같음]**, **[!UICONTROL 포함]** 또는 **[!UICONTROL 로 끝남]**)과 상위 1000개 치수 값을 사용할 수 있습니다.<br/>필터를 추가하려면 ![필터](/help/assets/icons/Filter.svg)를 선택하십시오.<br/>필터를 제거하려면 ![제거](/help/assets/icons/Remove.svg)를 선택하십시오.</li><li>**추가 작업**: 다음과 같은 작업을 선택하려면 ![추가](/help/assets/icons/More.svg)를 사용합니다.<ul><li>![이름 바꾸기](/help/assets/icons/Rename.svg) **[!UICONTROL 이름 바꾸기]**: 이벤트 또는 세그먼트의 이름을 바꿉니다.</li><li>![복제](/help/assets/icons/Duplicate.svg) **[!UICONTROL 복제]**: 이벤트 또는 세그먼트를 복제합니다.</li><li>![삭제](/help/assets/icons/Delete.svg) **[!UICONTROL 제거]**: 이벤트, 세그먼트 또는 분류를 제거합니다.</li><li>![세그먼트 편집](/help/assets/icons/Edit.svg) **[!UICONTROL 세그먼트 편집]**: [필터 빌더](/help/components/filters/filter-builder.md)에서 세그먼트를 편집하려면</li><li>![시작](/help/assets/icons/Star.svg) **[!UICONTROL 즐겨찾기에 추가]**: [필터 관리자](/help/components/filters/manage-filters.md)의 즐겨찾기 필터 목록에 세그먼트를 추가합니다.</li><li>![SaveAsFloppy](/help/assets/icons/SaveAsFloppy.svg) **[!UICONTROL 다른 이름으로 저장]**: 세그먼트를 새 구성 요소로 저장합니다. **[!UICONTROL 구성 요소에 세그먼트 저장]** 대화 상자에서 세그먼트 이름과 설명을 지정할 수 있습니다. ![StarOutline](/help/assets/icons/StarOutline.svg)을(를) 선택하여 새 세그먼트를 즐겨찾기로 표시할 수 있습니다. 세그먼트를 새 필터로 저장하려면 **[!UICONTROL 저장]**&#x200B;을 선택하세요.</li><li>![링크](/help/assets/icons/Link.svg) **[!UICONTROL 시작 및 반환 이벤트 연결]**.: [유지](types/retention.md) 분석에서 시작 및 반환 이벤트를 연결합니다.</li><li>![연결 해제](/help/assets/icons/Unlink.svg) **[!UICONTROL 시작 및 이벤트 연결 해제]**: [유지](types/retention.md) 분석에서 시작 및 이벤트 연결을 해제하고 반환합니다.</li></ul></li></ul> |
...
| ![메뉴 시각화](assets/menu-visualization.png){style="border:1px solid gray"} | **메뉴**<br/> Analysis Workspace의 안내식 분석 시각화에서 사용할 수 있습니다. | Analysis workspace에서 안내식 분석 시각화의 명령.<ul><li>![GraphScatter](/help/assets/icons/GraphScatter.svg) **[!UICONTROL 차트]**: 분석 차트만 표시합니다.</li><li>![테이블](/help/assets/icons/Table.svg) **[!UICONTROL 테이블]**: 분석 테이블만 표시합니다.</li><li>![TableAndChart](/help/assets/icons/TableAndChart.svg) **[!UICONTROL 모두]**: 분석의 차트와 테이블을 표시합니다.</li><li>![편집](/help/assets/icons/Edit.svg) **[!UICONTROL 편집]**: 분석의 구성을 편집하려면</li><li>![일정](/help/assets/icons/Calendar.svg) **[!UICONTROL *날짜 범위&#x200B;*]**: 분석에 사용할 날짜 범위를 구성합니다.</li></ul> |
