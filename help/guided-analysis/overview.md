...
| 분석 유형 | 보기 유형 | 설명 |
| --- | --- | --- |
| [!UICONTROL 기능 매트릭스] | [참여](types/engagement.md) | 기능 참여의 폭과 너비를 이해합니다. |
...
조직이 안내식 분석을 사용하도록 프로비저닝되면 제품 프로필 관리자는 Adobe Admin Console에서 해당 프로필에 대한 액세스를 추가하거나 제거할 수 있습니다.
