---
title: 유지
description: 귀하의 제품을 계속해서 사용하는 사용자의 수를 측정합니다.
...
![유지](/help/assets/icons/Retention.svg) **[!UICONTROL 유지]** 보기는 시간이 지남에 따라 사용자가 제품을 계속 사용하는 방법을 측정하므로 제품 시장 적합성을 이해하는 데 도움이 됩니다. 분석은 다음 두 가지 중요한 이벤트를 기반으로 사용자를 계산합니다.
