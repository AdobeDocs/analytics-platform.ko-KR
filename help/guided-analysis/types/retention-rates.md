...
다음 **[!UICONTROL 유지율]** 보기는 제품 시장 적합성을 이해하는 데 도움이 되는 시간에 따른 제품 내 반복 사용 동작을 사용자에게 보여 줍니다. 이 보기에서 가로축은 사용자의 초기 참여 이후 일 수를 나타내고 세로축은 다시 참여한 사용자의 백분율을 나타냅니다.
...
* **[!UICONTROL 이벤트 시작 및 반환]**: 사용자가 분석에 포함 및 유지할 자격을 얻기 위해 참여해야 하는 이벤트 기준입니다. 하나의 이벤트가 지원되지만 속성 필터를 포함할 수 있습니다.
