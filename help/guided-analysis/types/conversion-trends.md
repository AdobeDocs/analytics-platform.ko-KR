...
**[!UICONTROL 전환 트렌드]** 보기는 시간 경과에 따른 전환율 트렌드 시각화를 제공합니다. 가로축은 시간 간격인 반면, 세로축은 전환율을 나타냅니다.
...
* **최적화 작업 추적**: [마찰](friction.md)을 사용하여 개선하려는 주요 병목 현상을 식별한 후 이 보기를 사용하여 이러한 최적화가 시간에 따른 전환율에 미치는 영향을 추적할 수 있습니다.
...
* **[!UICONTROL 보기]**: 이 보기 형식과 [마찰](friction.md) 사이를 전환합니다.
...
>[!NOTE]
>
>전환 트렌드 보기 테이블의 **평균** 열이 [마찰 보기](friction.md) 테이블의 **합계** 열과 다릅니다. 전자는 간격 열의 평균(예: 일일 전환율 평균)이고 후자는 전체 날짜 범위에서 집계된 계산입니다.
