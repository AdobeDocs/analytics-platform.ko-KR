...
다음 **[!UICONTROL 전환 트렌드]** 보기 는 시간 경과에 따른 전환율의 트렌드 시각화를 제공합니다. 가로축은 시간 간격인 반면, 세로축은 전환율을 나타냅니다.
...
다음 [!UICONTROL 전환 트렌드] 보기 는 차트 위의 메뉴에서 조정할 수 있는 다음 차트 설정을 제공합니다.

* **[!UICONTROL 차트 유형]**: 사용하려는 시각화 유형입니다. 옵션은 다음과 같습니다 [!UICONTROL 라인].
