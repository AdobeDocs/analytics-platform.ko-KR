...
![NetGrowth](/help/assets/icons/NetGrowth.svg) **[!UICONTROL Net growth]** 보기 유형은 특정 기간 동안 사용자를 얻거나 잃는 속도에 대한 통찰력을 제공합니다. 가로축은 시간간격인 반면 세로축은 생장의 측정치이다.
...
[활성](active-growth.md) 보기 유형과 마찬가지로 사용자는 다음과 같이 정의됩니다.
...
* **[!UICONTROL 보기]**: 이 보기 유형과 [활성](active-growth.md) 간을 전환합니다.
