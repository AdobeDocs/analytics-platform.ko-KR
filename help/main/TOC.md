...
+ Customer Journey Analytics와 Adobe Analytics 비교 {#compare-aa-cja}
   + Customer Journey Analytics로 업그레이드 {#upgrade-to-cja}
      ...
      + [업그레이드 도중 및 이후의 Adobe Analytics](/help/getting-started/cja-upgrade/cja-upgrade-fully-move.md)
...
+ 사용 사례 {#cja-usecases}
   ...
   + 데이터 보기 {#data-views}
      ...
      + [BI 확장 사용 사례(보기)](/help/use-cases/data-views/bi-extension-usecases-looker.md)
