...
+ 릴리스 정보 {#releases}
  ...
  + {hide-from-toc}[사전 릴리스 정보](../release-notes/pre-release-notes.md)
...
+ 업그레이드 및 비교 {#compare-aa-cja}
  ...
  + Adobe Analytics와 비교 {#cja-aa-comparison}
    ...
    + [Cross-IMS 데이터 매핑](../getting-started/aa-vs-cja/mapping-data-ims-orgs.md)
  ...
  + Google Analytics 4에서 전환 {#ga-to-cja}
    + [개요](/help/getting-started/ga-to-cja/home.md)
    + [데이터 모델](/help/getting-started/ga-to-cja/data-model.md)
    + [보고서 등가물](/help/getting-started/ga-to-cja/reports.md)
    + [데이터 차이점](/help/getting-started/ga-to-cja/compare-data.md)
...
+ 데이터 보기 {#cja-dataviews}
  ...
  + 구성 요소 설정 {#component-settings}
    ...
    + {hide-from-toc}[범위](/help/data-views/component-settings/scope.md)
...
+ 구성 요소 {#cja-components}
  ...
  + 세그먼트 {#segments}
    ...
    + [하위 이벤트 분석](/help/components/segments/sub-event.md)
...
+ 결합 {#stitching}
  ...
  + [결합 활성화](/help/stitching/use-stitching-ui.md)
  + [결합 검증](/help/stitching/validate.md)
  + [자주 묻는 질문](/help/stitching/faq.md)
  + B2B {#b2b}
    + {hide-from-toc}[계정 연결 사용자](/help/stitching/b2b/b2b-person-to-account-stitching.md)

+ 총 모집단 보고 {#tpr}
  + {hide-from-toc}[개요](/help/tpr/tpr.md)
  + {hide-from-toc}[공유 조회](/help/tpr/shared-lookups.md)
...
+ 사용 사례 {#cja-usecases}
  ...
  + 데이터 보기 {#data-views}
    ...
    + BI 확장 기능 {#bi-extension}
      ...
      + [개별 차원 값 계산](/help/use-cases/data-views/bi-extension/count-distinct-dimension-values.md)
      + [일자 범위 이름을 사용하여 필터링](/help/use-cases/data-views/bi-extension/use-date-range-names-to-filter.md)
      + [세그먼트 이름을 사용하여 세분화](/help/use-cases/data-views/bi-extension/use-segment-names-to-segment.md)
      + [차원 값을 사용하여 세분화](/help/use-cases/data-views/bi-extension/use-dimension-values-to-segment.md)
      + [정렬](/help/use-cases/data-views/bi-extension/sort.md)
      + [제한](/help/use-cases/data-views/bi-extension/limits.md)
      + [변환](/help/use-cases/data-views/bi-extension/transformations.md)
...
+ 기술 노트 {#technotes}
  ...
  + [잘못된 ID](/help/technotes/badids.md)
  + [브라우저 및 언어](/help/technotes/browser-language.md)
