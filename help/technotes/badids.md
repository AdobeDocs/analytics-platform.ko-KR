...
* **[!UICONTROL 건너뛴 세부 정보 확인]** 대화 상자에서 레코드를 건너뛰는 가능한 이유로 **[!UICONTROL 잘못된 ID]**(또는 **[!UICONTROL BAVID]**)를 볼 수 있습니다. 연결의 [세부 정보 화면에서 **[!UICONTROL 생략된 레코드]** 아래의 **[!UICONTROL 세부 정보 확인]**(가능한 경우)을 사용합니다](/help/connections/create-connection.md).
...
* `identityMap['namespace_value'][0].id`(`identityMap`에서 `namespace_value`(으)로 정의된 필드)
