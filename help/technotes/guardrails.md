...
| 이름 | 값 | 제한 유형 | 설명 |
|---|--:|---|---|
| 다시 시도 시간 초과 | 90 | 시스템 강제 보호 | 다른 동시 요청으로 인해 발생할 수 있는 결과 반환에 요청이 너무 오래 걸려 다시 요청하기 전까지 보고 엔진이 응답하는 최대 시간(초)입니다. 다시 요청할 수 있습니다. |
...
| 계산된 지표 | 50,000 | 시스템 강제 보호 | 조직의 최대 계산된 지표 수입니다. |
...
|---|---|
| Edge Network에 Edge Network SDK / API | 7분 미만 |
| 스트리밍 커넥터 | &lt; 17분 |
