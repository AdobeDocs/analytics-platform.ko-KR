...
description: Customer Journey Analytics에서 액세스 제어를 구현하는 방법에 대해 알아보세요.
...
Customer Journey Analytics는 제품 관리자 역할, 제품 프로필 관리자 역할, 사용자 수준 액세스 등 세 가지 액세스 수준 또는 세 가지 역할로 관리됩니다. 여기서는 이 역할에 대해 자세하게 설명합니다.

또한 이 문서는 Workspace 큐레이션 및 행 수준 및 가치 수준 액세스 제어와 같이 액세스를 제한하는 보다 세분화된 방법에 대해 논의합니다.
...
1. [Admin Console](https://adminconsole.adobe.com/enterprise/)로 이동합니다.
...
제품 관리자는 Customer Journey Analytics 내에서 대부분의 작업을 완료할 수 있는 권한을 보유합니다.

제품 관리자에게는 기본적으로 다음 작업을 수행하는 데 필요한 권한이 부여됩니다.

* 프로젝트, 세그먼트, 계산된 지표, 대상자, 주석 또는 다른 사용자가 만든 세그먼트 업데이트 및 삭제
...
[Admin Console](https://adminconsole.adobe.com/enterprise/)의 **Customer Journey Analytics Product Profile**&#x200B;에서 제품 관리자로 추가되는 것 외에도, Customer Journey Analytics 내에서 다음 작업을 완료하려면 추가 권한이 필요합니다.
...
* Journey Optimizer가 Journey Optimizer 연결이 있는 Customer Journey Analytics과 통합된 경우, 연결에 액세스하려면 여정 권한도 추가해야 합니다.
  ...
  | 카테고리 | 사용 권한 | 설명 |
  |---|---|---|
  | [!UICONTROL 여정] | [!UICONTROL 여정 이벤트, 데이터 소스 및 작업 보기] | 여정 이벤트, 여정 사용자 정의 작업 및 여정 데이터 소스에 대한 읽기 전용 액세스 권한 |
...
| [!UICONTROL 보고 도구] | [!UICONTROL Analysis Workspace 액세스] | 사용자가 [Analysis Workspace](/help/analysis-workspace/home.md)에 액세스할 수 있도록 합니다. |
| [!UICONTROL 보고 도구] | [!UICONTROL 가이드 분석 액세스] | 사용자가 [가이드 분석](/help/guided-analysis/overview.md)에 액세스할 수 있도록 합니다. |
| [!UICONTROL 보고 도구] | [!UICONTROL 계산된 지표 만들기] | 사용자가 [계산된 지표](/help/components/calc-metrics/calc-metr-overview.md)를 만들 수 있도록 합니다. 사용자는 본인이 만든 계산된 지표 또는 본인에게 공유된 계산된 지표만 태그 지정, 공유, 삭제, 이름 변경, 승인, 승인 취소할 수 있습니다. |
| [!UICONTROL 보고 도구] | [!UICONTROL 세그먼트 만들기] | 사용자가 [세그먼트](/help/components/segments/seg-overview.md)를 만들 수 있도록 합니다. 사용자는 본인이 만든 세그먼트 또는 본인에게 공유된 세그먼트만 태그 지정, 공유, 삭제, 이름 변경, 승인 및 승인 취소할 수 있습니다. |
...
| [!UICONTROL 보고 도구] | [!UICONTROL 예측] | 사용자가 Analysis Workspace의 [예측](../analysis-workspace/c-forecast/forecasting.md) 기능에 액세스할 수 있도록 합니다. |
| [!UICONTROL 보고 도구] | [!UICONTROL AI 어시스턴트: 제품 지식] | 사용자가 [AI 어시스턴트](../ai-assistant.md)에 액세스하여 제품 지식을 얻도록 합니다. |
| [!UICONTROL 보고 도구] | [!UICONTROL 인텔리전트 캡션] | 사용자가 [인텔리전트 캡션](/help/analysis-workspace/visualizations/intelligent-captions.md)에 액세스할 수 있도록 합니다. |
| [!UICONTROL 데이터 보기 도구] | [!UICONTROL 전체 테이블 내보내기] | 사용자가 [클라우드로 전체 테이블을 내보내기](/help/analysis-workspace/export/export-cloud.md)할 수 있도록 합니다. |
| [!UICONTROL 데이터 보기 도구] | [!UICONTROL CJA BI 확장 기능] | 사용자가 [BI 확장 기능](../data-views/bi-extension.md)을 사용하도록 합니다. |
