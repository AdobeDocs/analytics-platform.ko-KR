...
>[!NOTE]
>
>이 빠른 시작 안내서는 배치 데이터를 Adobe Experience Platform에 수집하고 Customer Journey Analytics에서 사용하는 방법에 대한 간단한 안내서입니다. 추가 정보를 참고하는 경우 연구하는 것이 좋습니다.
...
다음을 참조하십시오 [기존 XDM 스키마 위에 CSV 파일 매핑](https://experienceleague.adobe.com/docs/experience-platform/ingestion/tutorials/map-csv/existing-schema.html) 자세한 내용은 다음을 참조하십시오.
