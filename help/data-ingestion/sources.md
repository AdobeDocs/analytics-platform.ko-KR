...
>[!NOTE]
>
>소스 커넥터를 사용하는 데이터를 Adobe Experience Platform으로 수집하고 Customer Journey Analytics에서 사용하는 방법에 대한 간단한 안내서입니다. 추가 정보를 참고하는 경우 연구하는 것이 좋습니다.
...
2. 사용 가능한 소스 커넥터 목록에서 소스 커넥터를 선택합니다. 각 커넥터는 유사한 워크플로를 따릅니다.
   ...
   - **[!UICONTROL 데이터 흐름 세부 정보]**: 데이터 흐름에 대한 추가 세부 사항(예: 이름 및 사용할 데이터 세트)를 제공합니다.
