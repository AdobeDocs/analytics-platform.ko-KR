...
1. **[!UICONTROL 설정]** 탭을 선택합니다. [!UICONTROL 세션 설정] 아래에서 다음 작업을 수행합니다.
   ...
   1. 데이터 보기를 세그먼트화하려면 **[!UICONTROL 세그먼트 추가]** 드롭다운 메뉴에서 세그먼트를 선택하십시오. 또는 **[!UICONTROL _여기에 세그먼트 놓기_]**&#x200B;의 왼쪽 창에 있는 ![세그먼테이션](/help/assets/icons/Segmentation.svg) **[!UICONTROL 세그먼트]**&#x200B;에서 세그먼트를 끌어서 놓을 수 있습니다.
