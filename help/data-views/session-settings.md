...
1. **[!UICONTROL 설정]** 탭을 선택합니다. [!UICONTROL 세션 설정] 아래에서 다음 작업을 수행합니다.
   ...
   1. 데이터 보기를 세그먼트화하려면 **[!UICONTROL 세그먼트 추가]** 드롭다운 메뉴에서 세그먼트를 선택하십시오. 또는 ![여기에 세그먼트 놓기](/help/assets/icons/Segmentation.svg)의 왼쪽 창에 있는 **[!UICONTROL 세그먼테이션]** **[!UICONTROL _세그먼트_]**&#x200B;에서 세그먼트를 끌어서 놓을 수 있습니다.

      공유 및 액세스 권한이 있고 데이터 보기에 대해 정의한 구성 요소를 기반으로 평가할 수 있는 세그먼트만 나열됩니다.

   1. **[!UICONTROL 지표를 사용하여 새 세션 시작]** 드롭다운 메뉴에서 지표를 선택합니다. 또는 ![여기에 지표 놓기](/help/assets/icons/Event.svg)의 왼쪽 창에 있는 **[!UICONTROL 이벤트]** **[!UICONTROL _지표_]**&#x200B;에서 지표를 끌어서 놓을 수 있습니다. 선택한 지표는 새 세션의 시작을 정의합니다. 지표를 여러 개 정의할 수 있습니다.
      ...
      그런 다음 지표로 **[!UICONTROL Launch]** 지표를 끌어서 놓거나 선택하여 새 세션을 정의합니다.

      ![세션 설정 론치](assets/session-settings-launches-metric.png)



1. **[!UICONTROL 저장]** 또는 **[!UICONTROL 저장 후 마침]**&#x200B;을 선택하여 세션 설정 정의를 저장합니다.
