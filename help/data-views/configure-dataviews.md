...
* 고객 경로 분석의 속성 설정은 비파괴 및 소급 적용됩니다. 즉, Customer Journey Analytics에서는 데이터 세트에 되돌이킬 수 없는 손상을 줄 수 없습니다. 실수로 어떤 것을 삭제하더라도 언제든지 Experience Platform으로 돌아가 데이터 세트를 다시 가져올 수 있습니다. 그러나 데이터 세트를 다시 가져올 경우 추가 비용이 발생할 수 있습니다.
