...
| [!UICONTROL 첫 번째 세션] | 지표 | 보고 기간 내에 개인이 정의한 첫 번째 세션입니다 |
...
| [!UICONTROL 세션 반환] | 지표 | 사람의 첫 번째 세션이 아닌 세션 수입니다. |
...
| [!UICONTROL 세션 유형] | 차원 | 이 차원은 다음 두 가지 값을 갖습니다. 1) [!UICONTROL 처음] 2) 돌아가라. 다음 [!UICONTROL 처음] 라인 항목에는 개인이 정의한 첫 번째 세션으로 결정된 세션의 모든 동작(즉, 이 차원에 대한 지표)이 포함됩니다. 기타 모든 항목이 [!UICONTROL 재방문] 라인 항목(모든 항목이 세션에 속한다고 가정). 지표가 세션의 일부가 아닌 경우 이 차원에 대한 &#39;적용할 수 없음&#39; 버킷에 속합니다. [자세히 알아보기](/help/data-views/data-views-usecases.md) |
