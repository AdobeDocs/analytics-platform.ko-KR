...
| [!UICONTROL 기회] | 지표 | [!UICONTROL 연결]에 지정된 기회 ID를 기반으로 하는 기회입니다. |
| [!UICONTROL 구매 그룹] | 지표 | [!UICONTROL 연결]에 지정된 구매 그룹 ID를 기반으로 하는 구매 그룹입니다. |
...
| [!BADGE B2B 에디션]{type=Informative url="https://experienceleague.adobe.com/ko/docs/analytics-platform/using/cja-overview/cja-b2b/cja-b2b-edition" newtab=true tooltip="Customer Journey Analytics B2B 에디션"}<br/>[!UICONTROL 계정 ID] | 차원 | 연결에서 계정 컨테이너를 사용하는 경우의 [!UICONTROL 계정 ID]입니다. |
