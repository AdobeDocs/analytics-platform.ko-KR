...
세션이 만료되기 전에 이벤트 간의 비활성 기간을 결정하면 새 세션이 시작됩니다. 기간은 필수 입력 항목입니다. 이벤트에 특정 지표가 포함되면 새 섹션이 강제로 시작될 수도 있습니다. 다음을 참조하십시오 [컨텍스트 인식 세션](context-aware-sessions.md) 을 참조하십시오.
