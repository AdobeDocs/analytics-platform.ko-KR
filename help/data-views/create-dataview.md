...
| [!UICONTROL 스키마 데이터 유형] | 구성 요소가 문자열인지, 정수인지 여부를 나타냅니다. |
...
| 설정 | 설명/사용 사례 |
| --- | --- |
| [!UICONTROL 속성 설정] | 이 지표를 사용할 때 기본적으로 이 지표에 적용할 속성 설정을 지정할 수 있습니다. 이 기본값은 자유형 테이블 또는 계산된 지표에서 재정의할 수 있습니다. |
...
| [!UICONTROL 전환 확인 기간] | 지표에 대한 기본 전환 확인 기간을 지정할 수 있습니다. [!UICONTROL 비기본 속성 모델 사용] 설정을 켜는 경우에만 활성화됩니다. 옵션은 개인(보고 기간), 세션, 맞춤형입니다. 맞춤형을 선택하면 속성 IQ와 마찬가지로 일/주/월 등 (최대 90일)을 선택할 수 있는 옵션도 제공됩니다. 동일한 스키마 필드를 사용하여 여러 지표를 가질 수 있지만 각 지표에는 별도의 전환 확인 기간이 있습니다. |
