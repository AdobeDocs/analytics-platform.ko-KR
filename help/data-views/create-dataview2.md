...
이 설정을 사용하면 쿼리 시간에 보고 중인 기본 데이터를 수정할 수 있습니다. 필터와 같지 않습니다. 그러나 필터는 경로 지정 및 속성을 준수하며 이 새로운 차원을 따릅니다.
...
| [!UICONTROL 일치] | 속성 및 필터 이전에 보고할 때 고려할 값을 지정할 수 있습니다(예: &quot;error&quot; 구문을 포함하는 값만 사용). 다음을 지정할 수 있습니다.**[!UICONTROL 모든 기준이 충족되는 경우]** 또는 **[!UICONTROL 기준이 충족되는 경우]** |
