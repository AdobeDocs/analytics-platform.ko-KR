...
다음 레이블 및 마케팅 작업은 Customer Journey Analytics에게 특별한 관심사입니다.


| 레이블 | 마케팅 액션 | 정의 |
|---------|----------|---------|
| `C2` | [!UICONTROL 서드파티로 내보내기] | 레이블 및 관련 마케팅 작업은 해당 DULE 정책이 활성화된 경우 데이터를 서드파티에 내보낼 수 없음을 나타냅니다. |
| `C3` | [!UICONTROL 직접 식별 가능한 데이터와 결합] | 레이블 및 관련 마케팅 작업은 해당 DULE 정책이 활성화된 경우 데이터를 직접 식별 가능한 정보와 결합하거나 사용할 수 없음을 나타냅니다. |
| `C8` | [!UICONTROL Analytics] | 레이블 및 관련 마케팅 작업은 해당 DULE 정책이 활성화된 경우 데이터를 조직의 웹 사이트 또는 앱의 분석에 사용할 수 없음을 나타냅니다. |
| `C9` | [!UICONTROL 데이터 과학] | 해당 DULE 정책이 활성화된 경우 레이블 및 관련 마케팅 작업은 데이터 과학 워크플로우에서 데이터를 사용할 수 없음을 나타냅니다. |
| `C12` | [!UICONTROL 데이터 내보내기] | 레이블 및 관련 마케팅 작업은 해당 DULE 정책이 활성화된 경우 이 방식으로 레이블이 지정된 스키마 필드를 Customer Journey Analytics(보고, 내보내기, API 등을 통해)에서 내보내거나 다운로드할 수 없음을 의미합니다. |
...
Experience Platform에 나타나고 보고 및 데이터 내보내기에 영향을 줄 수 있는 Adobe 정의 정책 5개를 Customer Journey Analytics에서 사용할 수 있습니다.


| 정책 | 레이블 |
|---------|----------|
| [!UICONTROL 타사 데이터 내보내기 제한] | `C2` |
| [!UICONTROL 직접 식별 가능한 데이터 조합 제한] | `C3` |
| [!UICONTROL 사용 분석 및 사용자 기반 측정 제한] | `C8` |
| [!UICONTROL 데이터 과학 제한] | `C9` |
| [!UICONTROL 데이터 내보내기 제한] | `C12` |
...
C3 또는 C8에서 하나 이상의 정책이 켜진 경우 특정 데이터 레이블이 적용된 해당 스키마 구성 요소를 데이터 보기에 추가할 수 없습니다.

C9로 하나 이상의 정책을 켜면 C9로 레이블이 지정된 스키마 구성 요소를 [Analytics MCP 서버](https://developer.adobe.com/analytics-mcp/docs/)에서 사용할 수 없습니다.
