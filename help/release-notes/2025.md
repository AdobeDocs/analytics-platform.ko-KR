...
| **임시 및 관계형 스키마 지원** | [Ad Hoc](https://experienceleague.adobe.com/ko/docs/experience-platform/xdm/tutorials/ad-hoc) 및 [관계형 스키마](https://experienceleague.adobe.com/en/docs/experience-platform/xdm/schema/relational)는 Experience Platform용 데이터 수집 및 데이터 미러 워크플로우에서 사용됩니다. |  | 2025년 9월 23일(원래 2025년 8월 28일 릴리스로 계획됨) |
