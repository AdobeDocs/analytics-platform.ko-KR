...
| **스트리밍 미디어 컬렉션 보고 - AMA(분당 평균 시청 시간)** | 이제 평균 분당 시청 대상자 패널을 CJA에서 사용할 수 있습니다. 스트리밍 미디어 컬렉션 추가 기능을 구매한 고객은 평균 분당 시청 대상자 패널을 사용하여 콘텐츠의 평균 소비량을 보다 세부적으로 파악할 수 있습니다. <p>평균 분당 시청 대상자를 통해 모든 길이 또는 모든 장르의 프로그램을 비교할 수 있습니다. 또한 고객은 이 디지털 평균 분당 시청 대상자를 유선 TV 평균 분당 지표와 비교하거나 추가할 수 있습니다.</p><p> 이 패널을 통해 기간 분류가 이후에 업데이트된 경우에도 사용자 정의 기간의 대상자 평균을 보다 유연하게 측정할 수 있습니다.</p><p>자세한 내용은 [미디어 평균 분당 시청 대상자 패널](/help/analysis-workspace/c-panels/average-minute-audience-panel.md)을 참조하십시오.</p> |  | 2024년 3월 12일 |
...
| **스트리밍 미디어 컬렉션 보고 - AMA(분당 평균 시청 시간)** | 이제 평균 분당 시청 대상자 패널을 CJA에서 사용할 수 있습니다. 스트리밍 미디어 컬렉션 추가 기능을 구매한 고객은 평균 분당 시청 대상자 패널을 사용하여 콘텐츠의 평균 소비량을 보다 세부적으로 파악할 수 있습니다. 평균 분당 시청 대상자를 통해 모든 길이 또는 모든 장르의 프로그램을 비교할 수 있습니다. 또한 고객은 이 디지털 평균 분당 시청 대상자를 유선 TV 평균 분당 지표와 비교하거나 추가할 수 있습니다. 이 패널을 통해 기간 분류가 이후에 업데이트된 경우에도 사용자 정의 기간의 대상자 평균을 보다 유연하게 측정할 수 있습니다. |  | 2024년 3월 14일 |
