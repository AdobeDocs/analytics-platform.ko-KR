...
| **Adobe Product Analytics: 단계 Insights 향상** | [단계](/help/guided-analysis/types/funnel.md) 보기에서 차트 및 표를 더 잘 이해할 수 있도록 작성된 인사이트가 카테고리, 델타 및 설명을 포함하도록 향상되었습니다. | 2024년 4월 17일 | 2024년 4월 26일 |
| **Adobe Product Analytics: 보존 보기 향상** | 보다 심층적이고 사용자 지정 가능한 보존 통찰력을 제공하기 위해 [보존](/help/guided-analysis/types/retention.md) 보기에 몇 가지 기능이 추가되었습니다.<ul><li>시작 및 반환 이벤트 연결 해제</li><li>단일 보기에서 여러 반환 이벤트 비교</li><li>이후(제한 없음), 각각(제한 있음) 및 대괄호로 구분된 설정을 사용하여 적용된 보존 모델을 사용자 정의</li><li>차트에서 개별 코호트 행 표시 및 숨기기</li></ul> | 2024년 4월 24일 | 2024년 5월 8일 |
| **Adobe Product Analytics: 단일 이동 단계 내에서 이벤트 비교** | 이제 [단계](/help/guided-analysis/types/funnel.md) 보기의 단일 단계 단계에서 이벤트를 비교할 수 있습니다. 이는 여정에 단계 옵션이 있거나 A/B 실험이 실행되는 단계가 있는 경우 특히 유용합니다. | 2024년 4월 23일 | 2024년 5월 3일 |
