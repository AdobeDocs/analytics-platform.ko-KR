...
| 실시간 고객 프로필에 게시하는 대상자 | 고객 타겟팅 및 개인화를 위해 CJA에서 검색된 대상자를 Adobe Experience Platform/실시간 고객 프로필에 게시할 수 있습니다. [자세히 알아보기](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-components/audiences/audiences-overview.html?lang=ko) | 2022년 8월 17일 |
