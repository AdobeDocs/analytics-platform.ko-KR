...
| 부울 필드 지원 | 이제 Customer Journey Analytics는 부울 필드를 지원합니다. [자세히 알아보기](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-dataviews/component-settings/behavior.html) | 2021년 9월 16일 |
