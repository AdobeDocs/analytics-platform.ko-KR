...
| **Adobe Product Analytics의 주석** | 이제 가이드 분석이 Customer Journey Analytics에서 생성된 주석을 조회하는 기능을 지원합니다. [자세히 알아보기](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-components/annotations/overview.html) | 해당 사항 없음 | 2023년 10월 4일 |
