...
| 2022년 6월 | 업데이트 [플로우 시각화 워크플로우](/help/analysis-workspace/visualizations/c-flow/create-flow.md) |
| 2022년 6월 | 에 대한 새 설명서 [실시간 고객 프로필에 대상 게시](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-components/audiences/audiences-overview.html) |
...
| 2022년 2월 | Adobe Analytics에서 CJA로 이동하는 관리자를 위한 새로운 안내서입니다. [Adobe Analytics-Customer Journey Analytics 진화](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-overview/aa-to-cja.html?lang=ko-KR) |
...
| 2020년 2월 27일 | 업데이트 [Customer Journey Analytics 기능 지원](/help/getting-started/aa-vs-cja/cja-aa.md) |
