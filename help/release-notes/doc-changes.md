...
| --- | --- |
| **2025년 6월** | |
| 새 바로 가기 작업 | 이제 Analysis Workspace의 새 키보드 단축키를 사용하여 프로젝트에서 [Workspace 패널을 위/아래로 이동](/help/analysis-workspace/build-workspace-project/fa-shortcut-keys.md#move-panel-actions)할 수 있습니다. |
| **2025년 5월** | |
| Customer Journey Analytics [!BADGE B2B 에디션]{type=Informative url="https://experienceleague.adobe.com/ko/docs/analytics-platform/using/cja-overview/cja-b2b/cja-b2b-edition" newtab=true tooltip="Customer Journey Analytics B2B 에디션"} | 다음을 포함하여 곧 출시될 Customer Journey Analytics B2B 에디션에 대한 초안 설명서: <ul><li>새로운 [개요](/help/getting-started/cja-b2b-edition.md), [개념 및 기능](/help/getting-started/cja-b2b-concepts-features.md), [빠른 시작 안내서](/help/getting-started/cja-b2b-quick-start-guide.md), [전환 안내서](/help/getting-started/cja-b2b-transition.md), [사용 사례](/help/use-cases/b2b/b2b-edition/use-cases-overview.md) 문서 및</li><li>기존 설명서에 대한 다수의 업데이트.</li></ul>Customer Journey B2B 에디션 설명서, 문서 및 기능은 [!BADGE B2B 에디션]{type=Informative url="https://experienceleague.adobe.com/ko/docs/analytics-platform/using/cja-overview/cja-b2b/cja-b2b-edition" newtab=true tooltip="Customer Journey Analytics B2B 에디션"} 배지로 레이블이 지정됩니다. |
...
| 연결 | 곧 출시될 Customer Journey B2B 에디션에 맞춰 Customer Journey Connections 설명서를 다시 작업하고 업데이트했습니다. |
...
| **2022년 10월** | |
| 2022년 10월 | [예약된 프로젝트에 대한 암호 보호](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-workspace/curate-share/t-schedule-report.html?lang=ko#password) 관련 새로운 주제. 이 기능은 [HIPAA 준비](https://www.adobe.com/kr/trust/compliance/hipaa-ready.html)의 지원을 받습니다. |
