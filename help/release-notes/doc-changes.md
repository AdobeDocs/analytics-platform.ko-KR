...
| --- | --- |
| **2025년 5월** | |
| 결합 유효성 검사 | [유효성 검사](/help/stitching/validate.md)에 인증 성공률과 전체 개인 식별 성능에 영향을 주는 식별 결합에 대한 설명서를 추가했습니다. |
| 이벤트 깊이 차원 | 데이터 보기를 위한 [표준 차원](/help/components/dimensions/overview.md#standard-dimensions)의 일부인 새 이벤트 깊이 차원에 대한 설명서입니다. |
| **2025년 4월** | |
