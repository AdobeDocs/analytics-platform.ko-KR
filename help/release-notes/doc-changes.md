...
Customer Journey Analytics 설명서 시작 이후 다음과 같이 업데이트되었습니다.
...
| --- | --- |
| **2023년 6월** | |
| 크로스 채널 분석 및 결합 | 결합을 활성화하고 결합을 사용하여 크로스 채널 분석을 높이는 방법을 더 명확하게 하기 위해 예정된 변경 사항을 예상하여 크로스 채널 분석 기능 관련 설명서를 다음과 같이 편집합니다. [크로스 채널 분석](../use-cases/cross-channel/cross-channel.md) Customer Journey Analytics 기능 및 사용 사례로, [결합](../stitching/overview.md) 을(를) 수행하는 중요한 기능입니다. |
...
| 계산된 지표 업데이트 | 현재 Customer Journey Analytics 기능과 맞추기 위해 계산된 지표 설명서를 다음과 같이 업데이트했습니다. <ul><li>의 목록을 업데이트했습니다. [기본 계산된 지표](/help/components/calc-metrics/default-calcmetrics.md) Customer Journey Analytics에서 사용 가능</li><li>여러 계산된 지표 문서에서 업데이트된 스크린샷 및 절차 </li></ul> |
| **2023년 5월** | |
...
| 최적화 업데이트 | 에 대한 문서 업데이트됨 [Customer Journey Analytics 성능 최적화](/help/admin/optimizing-performance.md) |
...
| 파생 필드 | 에 대한 설명서를 추가했습니다. [파생 필드](../data-views/derived-fields/derived-fields.md) 기능. |
| **2023년 4월** |  |
...
| 프로젝트 필터(애드혹 및 빠른 필터) | 프로젝트 필터 및 제거된 중복 정보에 대한 간소화된 설명서입니다. 애드혹 필터를 만드는 단계는 이제 [빠른 필터를 만드는 단계](/help/components/filters/quick-filters.md)와 결합됩니다. |
| **2023년 3월** | |
| 의사 결정 관리 데이터 통합 | 방법을 설명하는 콘텐츠 추가됨 [Customer Journey Analytics에서 Adobe Journey Optimizer 의사 결정 관리 데이터 통합](/help/integrations/ajo-od.md). |
...
| 업데이트된 기능 지원 | 업데이트됨 [Customer Journey Analytics 기능 지원](/help/getting-started/aa-vs-cja/cja-aa.md) Customer Journey Analytics에서 사용할 수 있지만 AA에서 사용하거나 지원할 수 없는 기능의 표입니다. |
...
| 대상자 설명서에 대한 업데이트 | [지연 고려 사항](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-components/audiences/publish.html?lang=en#latency)에 대한 새로운 섹션. |
| 대상자 설명서에 대한 업데이트 | 대상을 만들면 Adobe에서 Experience Platform을 만듭니다 [새로운 각 Customer Journey Analytics 대상자에 대한 스트리밍 세그먼트](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-components/audiences/publish.html#after-audience-created). |
...
| 모바일 스코어카드 | 비교 날짜 범위를 표시하고 숨기는 방법을 설명하는 새로운 문서 섹션. 다음을 참조하십시오 [비교 날짜 범위 표시](/help/mobile-app/create-scorecard.md#show-comparison-dates) Customer Journey Analytics. |
| **2023년 1월** | |
...
| 데이터 수집 빠른 시작 안내서 | 방법에 대한 새로운 설명서 섹션 [데이터 수집 및 사용](/help/data-ingestion/data-ingestion.md) Customer Journey Analytics. |
...
| 프로필 및 조회 데이터 세트에 대한 오브젝트 배열 지원 | 업데이트됨 [개체 배열 사용](/help/use-cases/object-arrays.md) 및 [Adobe Experience Platform 대상자 수집](/help/use-cases/data-ingestion/ingest-aep-segments.md) 프로필 및 조회 데이터 세트에 대한 개체 배열 지원을 반영하도록 했습니다. |
...
| --- | --- |
| **2022년 12월** |  |
| 2022년 12월 16일 | 에 대한 새 주제 [Customer Journey Analytics 데이터 사용 측정 및 관리](/help/admin/estimate-usage.md). |
| **2022년 10월** | |
...
| 2022년 10월 | 에 대한 새 주제 [Customer Journey Analytics 감사 로그](/help/privacy/audit-log.md). |
| 2022년 10월 | [주요 지표 요약](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/visualizations/key-metric.html?lang=en) 시각화에 대한 새로운 주제. |
| 2022년 10월 | [데이터 보기의 날짜 및 날짜-시간 기능](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-dataviews/data-views-usecases.html?lang=en#date)에 대한 새로운 섹션 |
| 2022년 10월 | 모바일 앱: [사용자 정의 상세 보기](https://experienceleague.adobe.com/docs/analytics/analyze/mobapp/create-scorecard.html?lang=en#view-detail-slides)에 대한 새로운 주제. |
| 2022년 10월 | [Customer Journey Analytics 기능 지원](/help/getting-started/aa-vs-cja/cja-aa.md) 주제에 대한 업데이트. |
| **2022년 9월** | |
| 2022년 9월 | 의 새로운 사용 사례 [Google Analytics 데이터를 Customer Journey Analytics으로 마이그레이션](/help/use-cases/ga/overview.md). |
...
| 2022년 8월 | 에 대한 문서 업데이트 [Customer Journey Analytics 액세스 제어](/help/admin/cja-access-control.md). |
| 2022년 8월 | 에 대한 새 문서 [데이터 거버넌스 레이블 및 정책에 대한 Customer Journey Analytics 지원](/help/data-views/data-governance.md). |
...
| 2022년 7월 | [첫 번째 세션](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-dataviews/data-views-usecases.html?lang=en#new-repeat) 보고 문서. |
| **2022년 6월** | |
...
| 2022년 6월 | 에 대한 새 문서 [Adobe Analytics 및 Customer Journey Analytics 보고 기능 간의 데이터 처리 비교](/help/getting-started/aa-vs-cja/data-processing-comparisons.md). |
...
| 2022년 6월 | 에 대한 새 문서 [Customer Journey Analytics의 Analytics Labs](/help/labs/labs.md). |
...
| **2022년 5월** | |
| 2022년 5월 | 에 대한 문서 업데이트 [연결 만들기](/help/connections/create-connection.md) Customer Journey Analytics. |
| 2022년 5월 | 방법 관련 새로운 문서 [Customer Journey Analytics Report Builder에서 데이터 블록 관리](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-reportbuilder/manage-reportbuilder.html). |
| 2022년 5월 | 에 대한 새 문서 [Adobe Experience Platform 대상을 Customer Journey Analytics으로 수집](/help/use-cases/data-ingestion/ingest-aep-segments.md). |
| **2022년 4월** | |
...
| 2022년 4월 | 신규 [Adobe Analytics 사용자를 위한 Customer Journey Analytics 사용 안내서](/help/getting-started/aa-to-cja-user.md). |
| **2022년 3월** | |
| 2022년 3월 | 신규 [Customer Journey Analytics 주석 API 설명서](https://developer.adobe.com/cja-apis/docs/endpoints/annotations/). |
...
| **2022년 2월** | |
| 2022년 2월 | Adobe Analytics에서 Customer Journey Analytics으로 이동하는 관리자를 대상으로 한 새 안내서입니다. [Adobe Analytics-Customer Journey Analytics 진화](https://experienceleague.adobe.com/docs/analytics-platform/using/compare-aa-cja/aa-to-cja.html?lang=en) |
| **2022년 1월** | |
| 2022년 1월 | 에 대한 새로운 사용 사례 [Customer Journey Analytics에서 바인딩 차원 및 지표 사용](/help/use-cases/data-views/binding-dimensions-metrics.md) |
...
| 2022년 1월 | 에 대한 새 문서 [Adobe Analytics 데이터와 Customer Journey Analytics의 Analytics 데이터 비교](https://experienceleague.adobe.com/docs/analytics-platform/using/troubleshooting/compare.html) |
...
| **2021년 10월** | |
| 2021년 10월 | 설명서 [Report Builder](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-reportbuilder/report-buider-overview.html#) Customer Journey Analytics. |
...
| 2021년 9월 | 의 새 섹션 [보고서 세트 병합의 의미](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-overview/cja-faq.html#6.-considerations-when-merging-report-suites-in-cja) Customer Journey Analytics. |
| **2021년 8월** | |
| 2021년 8월 | 향상된 기능에 대한 새로운 섹션 [연결](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-connections/manage-connections.html) Customer Journey Analytics 경험. |
...
| 2021년 4월 | 에 대한 새 주제 [Customer Journey Analytics의 높은 카디널리티 차원](/help/components/dimensions/high-cardinality.md). |
| **2021년 3월** | |
...
| 2021년 2월 | 새로 게시됨 [CUSTOMER JOURNEY ANALYTICS API](https://www.adobe.io/cja-apis/docs/) 설명서를 참조하십시오. |
| **2021년 1월** | |
