...
| Experience Platform 대상자 수집 및 활용 | [Experience Platform 대상을 수집 및 사용](/help/use-cases/data-ingestion/ingest-aep-segments.md)하는 방법에 대한 사용 사례 문서를 업데이트했습니다. |
| Customer Journey Analytics으로 업그레이드할 조직 준비 | [Customer Journey Analytics으로 업그레이드할 조직을 준비하는 방법](/help/getting-started/cja-upgrade/cja-upgrade-org-readiness.md)에 대한 정보가 추가되었습니다. |
