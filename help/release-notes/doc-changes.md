...
| 플로우 시각화 성능 권장 사항 | 단일 플로우 시각화에 10개 이상의 노드를 확장하면 보고 시간에 영향을 줄 수 있다는 정보가 추가되었습니다. |
| 키에 대한 Adobe Azure 앱 액세스 권한을 부여하는 대체 방법 | Azure에서 Customer Journey Analytics에 대해 [고객 관리 키를 설정](/help/privacy/cmk.md#set-up-customer-managed-keys-for-customer-journey-analytics-on-azure)할 때 권한 부여 동의를 통해 권한을 부여하는 방법에 대한 정보가 추가되었습니다. |
| **2025년 6월** | |
