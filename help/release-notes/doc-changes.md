...
| --- | --- |
| **2025년 9월** | |
| 사용 인터페이스 | 연결에 업데이트된 [사용 인터페이스](/help/connections/manage-connections.md#usage)에 대한 설명서를 추가했습니다. |
| Journey Optimizer 데이터 세트 결합 | 결합에 사용할 수 있는 [자동으로 생성된 여정 최적화 데이터 세트 목록](/help/stitching/overview.md#journey-optimizer-datasets)이 문서화되었습니다. |
