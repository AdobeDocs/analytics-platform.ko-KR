...
| --- | --- |
| **2025년 5월** | |
| Customer Journey Analytics [!BADGE B2B edition]{type=Informative url="https://experienceleague.adobe.com/ko/docs/analytics-platform/using/cja-overview/cja-b2b/cja-b2b-edition" newtab=true tooltip="Customer Journey Analytics B2B 에디션"} | 다음을 포함한 예정된 Customer Journey Analytics B2B edition에 대한 설명서 초안: <ul><li>새 [개요](/help/getting-started/cja-b2b-edition.md), [개념 및 기능](/help/getting-started/cja-b2b-concepts-features.md), [빠른 시작 안내서](/help/getting-started/cja-b2b-quick-start-guide.md), [전환 안내서](/help/getting-started/cja-b2b-transition.md) 및 [사용 사례](/help/use-cases/b2b/b2b-edition/use-cases-overview.md) 문서 및</li><li>기존 설명서에 대한 다양한 업데이트.</li></ul>고객 여정 B2B edition 설명서, 문서 및 기능에는 [!BADGE B2B edition]{type=Informative url="https://experienceleague.adobe.com/ko/docs/analytics-platform/using/cja-overview/cja-b2b/cja-b2b-edition" newtab=true tooltip="Customer Journey Analytics B2B 에디션"} 배지로 레이블이 지정됩니다. |
| 결합 검사 | [유효성 검사](/help/stitching/validate.md)에 인증 성공률과 전체 개인 식별 성능에 영향을 주는 식별 결합에 대한 설명서를 추가했습니다. |
