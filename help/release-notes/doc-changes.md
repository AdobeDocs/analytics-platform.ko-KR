...
| 2022년 2월 | [Adobe Analytics-Customer Journey Analytics 진화](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-overview/aa-to-cja.html) |
...
| 2021년 11월 | 연결 세부 정보 페이지의 [[!UICONTROL 생략된 레코드]](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-connections/manage-connections.html#connection-details-settings)에 대한 업데이트된 설명서 |
...
| 2021년 10월 | [!UICONTROL 연결] [데이터 보존](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-connections/manage-connections.html#set-rolling-window-for-connection-data-retention)을 위한 롤링 기간.<p>**참고: 이 설정을 구현하려면 고객 지원 센터 또는 Adobe 계정 관리자에게 문의하십시오. 아직 CJA UI를 통해서는 사용할 수 없습니다.** |
