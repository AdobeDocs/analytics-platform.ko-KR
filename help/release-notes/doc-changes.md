...
| --- | --- |
| **2025년 9월** | |
| 컨텍스트 레이블 | 데이터 보기 구성 요소에서 [컨텍스트 레이블](/help/data-views/component-settings/overview.md#context-labels)의 사용 및 목적에 대한 배경 정보가 더 추가되었습니다. |
| **2025년 8월** | |
| Adobe Advertising과의 새로운 통합 | [Adobe Advertising과 통합](/help/integrations/advertising.md)에 대한 정보가 추가되었습니다. |
