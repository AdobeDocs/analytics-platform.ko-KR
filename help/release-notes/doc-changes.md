...
| 실시간 보고 | Customer Journey Analytics의 [실시간 보고](/help/components/real-time/real-time.md)에 대한 설명서를 추가했습니다. |
...
| 새로운 파생 필드 함수 | 새 파생 필드 함수에 대한 설명서: [날짜 계산](/help/data-views/derived-fields/derived-fields.md#date-math), [깊이](/help/data-views/derived-fields/derived-fields.md#depth) 및 [타입캐스트](/help/data-views/derived-fields/derived-fields.md#typecast). |
| **2025년 7월** | |
...
| 키에 Adobe Azure 앱 액세스 권한을 부여하는 대체 방법 | Azure에서 Customer Journey Analytics용 [고객 관리 키를 설정](/help/privacy/cmk.md#set-up-customer-managed-keys-for-customer-journey-analytics-on-azure)할 때 권한 부여 동의를 통해 권한을 부여하는 방법에 대한 정보를 추가했습니다. |
| **2025년 6월** | |
