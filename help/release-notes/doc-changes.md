...
| 날짜 | 설명 업데이트 |
| --- | --- |
| 2022년 2월 | [Adobe Analytics에서 Customer Journey Analytics로 마이그레이션 준비](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-overview/aa-to-cja.html?lang=ko) |
