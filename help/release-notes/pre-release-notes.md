...
| **Report Builder에서 보안 대상 지원** | Report Builder 추가 기능에 새로운 내보내기 대상이 추가되었습니다. 지원되는 클라우드 스토리지 대상은 다음과 같습니다. <ul><li>Amazon S3 Role ARN</li><li>Google Cloud Platform</li><li>Azure SAS</li><li>Azure RBAC</li></ul> |  | 2025년 6월 18일 |
