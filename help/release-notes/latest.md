...
| **Agent Orchestrator의 Data Insights Agent** <br/> Customer Journey Analytics의 올바른 레일에서 사용할 수 있을 뿐만 아니라 이제 Data Insights Agent을 Agent Orchestrator의 일부로 사용할 수 있습니다. 즉, 이제 Journey Optimizer 내부와 같은 다른 Experience Platform 앱에서 작업하는 동안 Customer Journey Analytics 데이터 및 기능에 의존하는 통찰력을 얻을 수 있습니다.<p>Customer Journey Analytics에서 Data Insights Agent에는 다음과 같은 개선 사항이 포함되어 있습니다.</p><ul><li>Agent Orchestrator을 통한 보다 일관된 사용자 경험</li><li>설명 요약 단락</li><li>근본 원인 분석을 통한 &quot;이유&quot; 질문에 대한 답변</li><li>인라인 테이블</li><li>그리고 훨씬 더!&lt;/l></ul><p>(참조할 설명서 링크입니다.)</p> | | 2026년 5월 말 |
