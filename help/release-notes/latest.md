...
| **프로필 및 조회 데이터에 대한 확장된 조회 지원** | 데이터 세트를 프로필 또는 조회 데이터 세트 내의 필드 조회로 추가하는 기능을 제공합니다. 이전에는 이벤트 데이터 세트만 지원되었습니다. [자세히 알아보기](/help/connections/create-connection.md) | 2023년 6월 21일 | 2023년 7월 12일 |
