...
| **연결부 결합** | Customer Journey Analytics 결합 단순화. 데이터 세트를 복제하고 복제된 데이터 세트에 결합을 적용하는 대신, 이제 Customer Journey Analytics에 데이터를 수집할 때 결합을 적용하므로 중복된 데이터 세트와 스키마가 필요하지 않습니다. <p>또한 고객 지원을 통해 결합을 요청하지 않고도 이제 [업데이트된 연결 UI에서 직접 결합을 시작](/help/stitching/use-stitching-ui.md)할 수 있습니다.</p><p> *이전에 전달된 출시 날짜는 추가적인 노력이 필요하여 연기되었습니다. 새로운 출시 날짜가 휴일 시즌과 겹치면서 출시에 대한 추가적인 제약이 발생합니다. 이제 연휴 기간 동안 안정성을 보장하고 중단을 최소화하기 위해 단계적 출시가 계획되어 있습니다.*</p> | 2025년 10월 28일 | 2026년 4월 30일 |
...
| **Analytics 소스 커넥터: Experience Platform에서 보고서 세트 검색** | 보고서 세트 수가 많은 경우 이제 Analytics Source 커넥터 데이터 흐름 워크플로우 내에서 연결할 [보고서 세트를 검색](/help/data-ingestion/analytics.md#set-up-an-adobe-analytics-source-connector)할 수 있습니다. | | 2025년 10월 30일 |
