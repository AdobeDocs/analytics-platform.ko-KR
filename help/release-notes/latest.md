...
| **Content Analytics: 유료 미디어 데이터** <br/>유료 미디어를 이제 Content Analytics의 세 번째 채널로 사용할 수 있습니다. [개요](/help/content-analytics/content-analytics.md), [채널 구성](/help/content-analytics/config/guided.md#channels), [구성 요소](/help/content-analytics/report/components.md) 및 [보고서](/help/content-analytics/report/report.md) 업데이트를 확인하세요. | | 2026년 9월 4일 |
