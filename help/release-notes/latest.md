...
| **CJA 데이터 보기에 대한 PowerBI 및 Tableau 액세스** | Customer Journey Analytics(CJA) SQL Connector를 사용하면 CJA에서 정의한 데이터 보기에 SQL로 액세스할 수 있습니다. Power BI, Tableau 또는 기타 비즈니스 인텔리전스 및 시각화 도구에 더 익숙한 데이터 엔지니어와 분석가는 이제 CJA 사용자가 Analysis Workspace 프로젝트에 사용하는 것과 동일한 데이터 보기를 기반으로 보고서와 대시보드를 만들 수 있습니다. [자세히 알아보기](/help/data-views/sql-connector.md) |  | 2023년 6월 30일 |
| **Experience Edge 지역 조회** | 데이터 스트림에 대해 Experience Edge 지역 조회가 활성화되면 CJA에서 지리적 위치 데이터를 사용하여 보고서를 작성할 수 있습니다. |  | 2023년 6월 30일 |
| **프로필 및 조회 데이터에 대한 조회 지원 확장** | 이벤트 데이터 세트뿐만 아니라 프로필 및 조회 데이터 세트에 조회 데이터 세트를 추가할 수 있습니다. | 2023년 6월 21일 | 2023년 7월 12일 |
| **통화 전환 지원** | CJA는 데이터 보기에서 지표 구성 요소 서식 지정의 일부로 통화 전환을 지원합니다. | 2023년 6월 21일 | 2023년 7월 19일 |
