...
| **파생 필드 - 타입캐스트 함수** | 타입캐스트 파생 필드 함수는 필드 유형을 즉시 변경하고 Customer Journey Analytics 내에서 필드를 추가 변환할 수 있도록 하는 기능을 제공합니다. | . | 2025년 7월 30일 |
| **파생 필드 - 데이터 수학 함수** | 데이터 수학 파생 필드 함수는 두 날짜 또는 날짜-시간 필드 간의 차이를 반환하는 기능을 제공합니다. | | 2025년 7월 30일 |
| **영역: 파생 필드 깊이 함수** | 깊이 파생 필드 함수는 기본 제공되는 표준 이벤트 깊이 차원에서 가능한 것과 유사하게 필드의 깊이를 반환하는 기능을 제공합니다. |  | 2025년 7월 30일 |
