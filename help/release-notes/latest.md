...
| **파생 필드 - 중복 제거 함수** | 파생 필드의 중복 제거 기능을 사용하면 값을 여러 번 카운트하지 않도록 할 수 있습니다.<p>[자세히 알아보기](/help/data-views/derived-fields/derived-fields.md#deduplicate)</p> |  | 2024년 7월 17일 목요일 |
