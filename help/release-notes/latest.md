...
| **Adobe Journey Optimizer에서 Customer Journey Analytics 데이터 보기 사용** | Customer Journey Analytics의 새 구성 옵션을 사용하면 수동으로 구성할 필요 없이 Adobe Journey Optimizer에서 사용할 Customer Journey Analytics 데이터 보기를 지정할 수 있습니다. <!-- add this in: <p>For information about how to enable this configuration option, see the [Compatibility](/help/data-views/create-dataview.md#compatibility) section in [Create or edit a data view](/help/data-views/create-dataview.md).</p> --><p>이전에는 Customer Journey Analytics에서 Adobe Journey Optimizer 데이터를 볼 때 연결 및 데이터 보기를 수동으로 구성해야 했습니다.</p><p>(참조할 설명서 링크)</p> |  | 2024년 6월 19일 목요일 |
