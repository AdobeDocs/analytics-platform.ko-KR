...
| **B2B 조회 데이터 세트의 변환** | 이제 다음을 수행할 수 있습니다. [B2B 조회 데이터 세트 변환](/help/connections/transform-datasets-b2b-lookups.md) 연결을 정의할 때입니다. 이러한 변환을 통해 B2B 데이터에 대한 사용자 기반 조회를 지원할 수 있습니다. | | 2024년 6월 6일 금요일 |
...
| **데이터 내보내기 사용 사례에 대한 새로운 설명서** | 이 새로운 섹션 개요 [데이터 내보내기 사용 사례](https://experienceleague.adobe.com/ko/docs/analytics-platform/using/cja-usecases/data-export/overview) 과 같은<ul><li>데이터 백업</li><li>데이터 유효성 검사</li><li>데이터 레이크, 데이터 웨어하우스 또는 BI 도구</li><li>AI/ML에 대한 준비</li></ul> Experience Platform 및 Customer Journey Analytics 기능을 사용하여 이를 구현하는 방법 | | 지금 사용 가능 |
