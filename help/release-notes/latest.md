...
| ----------- | ---------- | ------- | ---- |
| **이벤트 깊이 차원** | 데이터 보기에 대한 [필수 표준 구성 요소](/help/data-views/component-reference.md#required-standard-components) 목록에 새 이벤트 깊이 차원이 추가됩니다. |  | 2025년 5월 8일 금요일 |
| **전체 테이블 내보내기 제한 늘리기** | 전체 테이블 내보내기에 사용할 수 있는 열 수는 5차원 및 5지표에서 10차원 및 10지표로 증가합니다. 이러한 증가는 모든 Customer Journey Analytics 계층에 적용됩니다. 내보낼 수 있는 행 수에 대한 권한은 변경되지 않습니다. |  | 2025년 4월 30일 |
