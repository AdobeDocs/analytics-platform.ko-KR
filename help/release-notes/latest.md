...
| ----------- | ---------- | ------- | ---- |
| **사용 인터페이스에 대한 업데이트** | 이제 [사용 인터페이스](/help/connections/manage-connections.md#usage)에 핵심 데이터 볼륨 및 평균 행 크기에 대한 정보가 추가됩니다. | | 2025년 9월 4일 금요일 |
