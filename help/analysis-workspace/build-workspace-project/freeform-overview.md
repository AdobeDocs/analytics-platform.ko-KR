...
| 요소 | 설명 |
|---|---|
| [새 프로젝트 만들기](/help/analysis-workspace/home.md) | 새 프로젝트를 처음부터 시작하거나 사용자를 위해 만든 [템플릿](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/build-workspace-project/starter-projects.html?lang=en#analysis-workspace)에서 시작하려면 이 링크를 클릭합니다. |
