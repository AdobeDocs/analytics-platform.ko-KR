...
1. 폴더에 추가할 프로젝트를 하나 이상 선택합니다.
   ...
   ![선택한 세 개의 프로젝트를 보여 주는 프로젝트 테이블 보기.](/help/analysis-workspace/build-workspace-project/assets/move-tv-selected.png)

1. **다음으로 이동**&#x200B;을 선택합니다. 폴더 선택 대화 상자가 표시됩니다.

1. 드롭다운 메뉴에서 폴더 이름을 선택합니다.

   ![드롭다운 메뉴와 사용 가능한 하위 폴더를 보여 주는 폴더 선택 보기.](/help/analysis-workspace/build-workspace-project/assets/move-select-folder.png)
...
1. **추가**&#x200B;를 클릭합니다.
   ...
   ![이동한 세 개의 프로젝트를 보여 주는 선택한 하위 폴더입니다.](/help/analysis-workspace/build-workspace-project/assets/move-projects-added.png)

   이제 Workspace 랜딩 페이지에 폴더에 3개의 프로젝트가 있다고 표시됩니다.

   ![업데이트된 프로젝트 홈 페이지 목록에는 3개의 프로젝트가 있는 하위 폴더가 표시됩니다.](/help/analysis-workspace/build-workspace-project/assets/move-folders-updated.png)
...
1. 오른쪽 위의 **...** 줄임표 아이콘을 클릭합니다.
   ...
   ![줄임표 드롭다운 메뉴 옵션.](/help/analysis-workspace/build-workspace-project/assets/add-projects-elipsis.png)
...
1. **프로젝트 추가**&#x200B;를 선택하고 드롭다운 목록에서 추가할 프로젝트를 선택합니다.
   ...
   ![프로젝트 추가 목록.](/help/analysis-workspace/build-workspace-project/assets/select-add-projects.png)

   폴더에 여러 개의 프로젝트를 추가할 수 있습니다.

   ![세 개의 프로젝트가 표시되는 프로젝트 추가 창이 추가됩니다](/help/analysis-workspace/build-workspace-project/assets/move-add-multiple-projects.png)
