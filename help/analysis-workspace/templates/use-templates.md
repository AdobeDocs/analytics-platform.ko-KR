...
| **제품 사용 개요** | 귀하의 조직에서 Customer Journey Analytics를 어떻게 사용할 수 있는지 볼 수 있습니다.<p>**이를 통해** 귀하의 조직에서 Customer Journey Analytics를 사용하는 사람의 수, 사용 빈도, 그리고 시간에 따른 해당 데이터를 추세적으로 파악할 수 있습니다. 또한 생성된 프로젝트 수와 해당 프로젝트에 대한 세부 정보를 볼 수 있습니다. 기타 사용 통계 중에서 가장 일반적으로 사용되는 구성 요소, 시각화 및 패널을 확인합니다.</p><p>**학습한 내용을 바탕으로** 사용되지 않는 프로젝트나 구성 요소를 삭제하거나, 인기 기능에 대한 사용자 교육을 제공하는 등의 조치를 취할 수 있습니다.</p> |
