...
>abstract="**Customer Journey Analytics을 사용하는 사람 수, 사용 빈도, 시간 경과에 따른 사용 트렌드를 이해하는 데 도움이 됩니다**. 또한 생성 중인 프로젝트 수, 해당 프로젝트에 대한 세부 정보(예: 가장 일반적으로 사용되는 구성 요소, 시각화 및 패널) 및 기타 많은 사용 통계도 확인할 수 있습니다.<br/>**학습한 내용에 따라 사용하지 않는 프로젝트 또는 구성 요소를 삭제하거나 인기 있는 기능에 대한 사용자 교육을 제공하는 등 여러 가지 작업을 수행할 수 있습니다**."
...
| **제품 사용 개요**(준비 중) | 조직 내에서 Customer Journey Analytics 제품이 사용되는 방식을 확인합니다. <p>**Customer Journey Analytics을 사용하는 사람 수, 사용 빈도, 시간 경과에 따른 사용 트렌드를 이해하는 데 도움이 됩니다**. 또한 생성 중인 프로젝트 수, 해당 프로젝트에 대한 세부 정보(예: 가장 일반적으로 사용되는 구성 요소, 시각화 및 패널) 및 기타 많은 사용 통계도 확인할 수 있습니다.</p><p>**학습한 내용에 따라 사용하지 않는 프로젝트 또는 구성 요소를 삭제하거나 인기 있는 기능에 대한 사용자 교육을 제공하는 등 여러 가지 작업을 수행할 수 있습니다**.</p> |
