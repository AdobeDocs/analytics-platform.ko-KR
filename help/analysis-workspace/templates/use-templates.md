...
1. [!UICONTROL **템플릿**] 섹션에서 다음 탭 중 하나를 선택합니다.
   ...
   * **[!UICONTROL _login_company_name _템플릿]**: 조직에 대해 만들어진 모든 회사 템플릿을 표시합니다.
     ...
     회사 템플릿은 관리자만 만들 수 있습니다. 회사 서식 파일을 만드는 방법에 대한 자세한 내용은 [서식 파일 만들기 및 관리](/help/analysis-workspace/templates/create-templates.md)를 참조하십시오.
...
>title="Adobe Experience Manager 양식에 대한 성능 데이터를 봅니다."
>abstract="**이를 통해** Adobe Experience Manager의 가치 실현을 더 잘 이해할 수 있습니다.<br/>**학습한 내용을 바탕으로** Experience Manager 설정을 최적화하는 등 다양한 작업을 수행할 수 있습니다."
...
>title="판매 개선에 도움이 되는 상거래 활동에 대한 소매점을 위해 미리 제작된 인사이트를 확인할 수 있습니다. 이는 Magento 사용자를 대상으로 하지만 모든 온라인 소매점에서 활용할 수 있습니다."
...
| **기술 개요** | 운영 체제, 브라우저 및 장치와 같이 사용자가 사이트에 액세스하는 데 사용하는 기술과 관련된 정보를 봅니다. <p>**이렇게 하면**&#x200B;사이트에 액세스할 때 가장 자주 사용되는 기술을 더 잘 이해할 수 있습니다.</p><p>**학습한 내용에 따라** 사용 중인 기술에 맞게 사이트를 최적화하는 등 여러 가지 작업을 수행할 수 있습니다.</p> |
...
| **단어 검색 - 모두** | 유료 검색이든 자연어 검색이든, 방문자가 사이트에 접속하는 데 사용하는 검색 키워드를 확인할 수 있습니다. <p>**이를 통해** 검색에서 사용자가 사이트 트래픽을 초래하는 키워드를 더 잘 이해할 수 있습니다. </p><p>**학습한 내용을 바탕으로** 사용 중인 키워드와 사이트 트래픽을 유발하는 키워드 간의 SEO 격차를 파악하고 채우는 등 다양한 작업을 수행할 수 있습니다.</p><p>이 템플릿은 검색 키워드 차원을 사용합니다. </p> |
...
| **검색 범위 - 자연어** | 방문자가 사이트에 도달하는 데 사용하는 검색 키워드를 확인할 수 있으며, 이 키워드는 유료 검색 감지와 일치하지 않습니다.<p>**이를 통해** 사용자가 사용 시 사이트 트래픽을 초래하는 검색 엔진을 더 잘 이해할 수 있습니다.</p><p>**학습한 내용을 바탕으로** 사이트에 가장 많은 트래픽을 유도하는 검색 엔진에 SEO 작업을 집중하는 등 다양한 작업을 수행할 수 있습니다.</p><p>이 템플릿은 검색 엔진 - 자연어 차원을 사용합니다. </p> |
...
>abstract="**사람들이 앱을 어떻게 사용하고 있는지, 그리고 앱 값을 어떻게 얻고 있는지 더 잘 이해하는 데 도움이 됩니다**.<br/>**학습한 내용에 따라** 가장 인기 있는 기능을 보완하거나 개선하는 개발 기능 향상과 같은 다양한 작업을 수행할 수 있습니다."
...
>title="사이트의 이벤트, 세션 및 참여자 수를 시간(일 기준) 단위로 분류하여 확인합니다. 예: 1월 1일~1월 7일 범위의 보고서가 있을 경우, 각 날의 첫 번째 시간은 동일한 차원 항목으로 그룹화됩니다."
...
>title="사이트의 이벤트, 세션 및 참여자 수를 요일 단위로 분류하여 확인합니다. 예: 1월에 걸쳐 처리할 보고서가 있을 경우, 각 요일은 동일한 차원 항목으로 그룹화됩니다."
...
| **시간(일 기준)** | 사이트의 이벤트, 세션 및 참여자 수를 시간(일 기준) 단위로 분류하여 확인합니다. 예: 1월 1일~1월 7일 범위의 보고서가 있을 경우, 각 날의 첫 번째 시간은 동일한 차원 항목으로 그룹화됩니다.<p>**이를 통해** 사이트에 가장 많이 방문하거나 가장 적게 방문하는 시간대를 파악할 수 있습니다.</p><p>**학습한 내용을 바탕으로** 트래픽이 높은 시간대에 더 많은 컴퓨팅 리소스를 사이트에 할당하는 등 다양한 작업을 수행할 수 있습니다.</p><p>이 템플릿은 시간 차원을 사용합니다.</p> |
| **오전/오후** | 사이트의 이벤트, 세션 및 참여자 수를 오전 및 오후 단위로 분류하여 확인합니다. 예: 1월 1일~1월 7일 범위의 보고서가 있을 경우, 각 날의 오전 시간은 동일한 차원 항목으로 그룹화됩니다.<p>**이렇게 하면 사이트가 가장 자주 방문하거나 가장 자주 방문하지 않는 시간을 이해하는 데 도움이 됩니다**.</p><p>**학습한 내용을 바탕으로** 트래픽이 높은 시간대에 더 많은 컴퓨팅 리소스를 사이트에 할당하는 등 다양한 작업을 수행할 수 있습니다.</p><p>이 템플릿은 오전/오후 차원을 사용합니다.</p> |
...
| 템플릿 이름 | 이 템플릿 <!-- What do you do with it? What can it help you learn? and What are the potential actions? -->을(를) 사용하는 이유 |
| --- | --- | 
| [!UICONTROL **다중 채널 개요**] | 여러 채널의 트래픽 분포를 확인합니다. <p>**트래픽 및 참여를 더 성공적으로 유도하는 채널을 이해하는 데**&#x200B;도움이 될 수 있습니다. </p><p>**학습한 내용을 바탕으로** 투자 수익률이 가장 높은 채널에 마케팅 활동을 집중하는 등 다양한 작업을 수행할 수 있습니다.</p><p>이 템플릿은 사용자, 세션 및 이벤트 지표를 사용합니다.</p> |
