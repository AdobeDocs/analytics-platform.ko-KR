...
*이 문서에서는&#x200B;**Customer Journey Analytics**의 미디어 동시 뷰어 패널을 설명합니다. 이 문서의&#x200B;**Adobe Analytics**버전에 대한 [미디어 동시 뷰어 패널](https://experienceleague.adobe.com/en/docs/analytics/analyze/analysis-workspace/panels/media-concurrent-viewers)을 참조하세요.*
