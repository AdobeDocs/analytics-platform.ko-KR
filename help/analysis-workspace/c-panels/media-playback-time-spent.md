...
>title="미디어 재생 체류 시간"
>abstract="시간 경과에 따른 비디오 사용량을 분석하고, 다양한 세부 기간을 선택하고 분석 및 비교합니다.<br/><br/>**세부 기간**: 동시 뷰어를 확인할 수 있는 기간을 선택합니다.<br/>**패널 요약 번호(선택 사항)**: 이 옵션은 각 행의 날짜 또는 시간 세부 정보가 포함된 요약 번호를 표시합니다. 최대값은 최장 재생 체류 시간에 대한 세부 정보를 표시합니다. 최소값은 저점에 대한 세부 정보를 보여 줍니다. 합계는 재생 소요 시간의 총합에 대한 세부 정보를 보여 줍니다.<br/>**시리즈 분류(선택 사항)**: 세그먼트, 차원, 차원 항목 또는 날짜 범위별로 시각화를 분류합니다. 한 번에 최대 10개의 줄을 확인합니다. 분류는 단일 수준으로 제한됩니다.<br/>**시간 형식**: 이 옵션은 시각화에 대한 시간 형식을 시간 또는 분 단위로 표시합니다."
...
_이 문서에서는_ ![CustomerJourneyAnalytics](/help/assets/icons/CustomerJourneyAnalytics.svg) _**Customer Journey Analytics**_&#x200B;의 미디어 재생 소요 시간 패널을 설명합니다.<br/>_이 문서의_ ![AdobeAnalytics](/help/assets/icons/AdobeAnalytics.svg) _**Adobe Analytics** 버전에 대한 [미디어 재생 소요 시간 패널](https://experienceleague.adobe.com/en/docs/analytics/analyze/analysis-workspace/panels/media-playback-time-spent)을 참조하세요._
...
**[!UICONTROL 미디어 재생 소요 시간]** 패널을 사용하면 최대 동시 시청과 분류 및 비교 기능에 대한 세부 정보와 함께 시간 경과에 따른 재생을 분석할 수 있습니다.

Analysis Workspace에서 재생 소요 시간은 특정 시점에 미디어 스트림을 시청하는 데 소요된 시간입니다. 여기에는 일시 중지, 버퍼 및 시작 시간이 포함됩니다.

스트리밍 미디어 컬렉션 추가 기능을 구매한 고객은 재생 소요 시간을 분석하여 콘텐츠 품질과 시청자 참여에 대한 가치 있는 통찰력을 얻을 수 있습니다. 볼륨 또는 규모에 대한 문제 해결 또는 계획 수립 시 도움이 됩니다.

재생 소요 시간은 다음을 이해하는 데 도움이 됩니다.
...
데모 비디오는 ![VideoCheckedOut](/help/assets/icons/VideoCheckedOut.svg) [미디어 재생 소요 시간](https://video.tv.adobe.com/v/338699){target="_blank"}을 참조하십시오.
...
**[!UICONTROL 미디어 재생 소요 시간]** 패널을 사용하려면:
...
언제든지 ![미디어 재생 소요 시간 패널 편집](/help/assets/icons/Edit.svg)을 선택하여 패널을 편집하고 다시 빌드합니다.
...
| 질문 | 답변 |
|---|---|
| 자유 형식 테이블은 어디에 있습니까? 데이터 소스는 어떻게 볼 수 있습니까? | <p></p><p>이 보기에서는 자유 형식 테이블을 사용할 수 없습니다. 데이터 소스를 다운로드하려면 라인 차트의 컨텍스트 메뉴에서 CSV 파일을 다운로드하는 옵션을 선택합니다.</p> |
...
| 날짜 범위는 어떻게 비교합니까? | 단일 시각화에서 날짜 범위를 비교하려면 2개 이상의 날짜 범위를 끌어서 시리즈 분류를 사용합니다. 이러한 날짜 범위는 패널 날짜 범위를 덮어씁니다. |
