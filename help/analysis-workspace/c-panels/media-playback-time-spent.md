...
>title="미디어 재생 소요 시간"
>abstract="다양한 수준의 세부기간을 사용하여 시간 경과에 따른 비디오 소비를 분석하고 분류 및 비교 기능을 제공하는 패널을 만드십시오."
...
>title="미디어 재생 소요 시간"
>abstract="시간 경과에 따른 비디오 소비를 분석하고 다양한 세부 항목을 선택하고 분류하여 비교합니다.<br/><br/>**세부 기간**: 동시 뷰어를 볼 기간을 선택하십시오.<br/>**패널 요약 번호(선택 사항)**: 각 줄의 날짜 또는 시간 세부 정보와 함께 요약 번호를 표시하는 옵션입니다. 최대값은 최대 재생 시간 유형에 대한 세부 정보를 표시합니다. 최소값은 저점에 대한 세부 정보를 표시합니다. 합계는 재생 소요 시간의 총 합계에 대한 세부 정보를 보여 줍니다.<br/>**시리즈 분류(선택 사항)**: 세그먼트, 차원, 차원 항목 또는 날짜 범위별로 시각화를 분류합니다. 한 번에 최대 10개의 줄을 봅니다. 분류는 단일 수준으로 제한됩니다.<br/>**시간 형식**: 시각화의 시간 형식을 시간 또는 분 단위로 표시하는 옵션입니다."
