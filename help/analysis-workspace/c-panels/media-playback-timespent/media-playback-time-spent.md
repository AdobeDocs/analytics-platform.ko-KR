...
1. 미디어 재생 소요 시간 패널을 사용자 정의합니다.

   특정 구성 옵션에 대한 자세한 내용은 [미디어 재생 소요 시간 패널 입력 및 출력](/help/analysis-workspace/c-panels/media-playback-timespent/panel-inputs-outputs.md).
