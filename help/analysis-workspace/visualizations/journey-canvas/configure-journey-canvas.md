...
1. [!UICONTROL **빌드**]&#x200B;를 선택합니다.
   ...
   Journey Optimizer이 없거나 Journey Optimizer 여정을 선택하지 않은 경우 여정에 노드를 추가할 수 있는 빈 캔버스가 표시됩니다.
