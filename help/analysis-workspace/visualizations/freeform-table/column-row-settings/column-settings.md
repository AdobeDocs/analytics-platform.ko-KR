...
액세스하려면 [!UICONTROL 열 설정]를 클릭하고 자유 형식 테이블을 프로젝트로 드래그한 다음 설정 아이콘을 클릭합니다 ![열 설정](https://spectrum.adobe.com/static/icons/workflow_18/Smock_Settings_18_N.svg) 열 머리글에서.
...
1. 자유 형식 테이블 열의 지표에 있는 설정 (톱니바퀴) 아이콘을 클릭합니다.
   ...
   ![데이터 설정 옵션을 강조 표시하는 열 설정 옵션: 기본값이 아닌 속성 모드를 사용합니다.](assets/attribution-checkbox.png)
...
2. **[!UICONTROL 데이터 설정]**&#x200B;에서 **[!UICONTROL 기본값이 아닌 속성 모델 사용]**&#x200B;을 선택합니다. 다른 속성 모델에 대한 자세한 내용은 [속성 모델](/help/data-views/component-settings/attribution.md)을 참조하십시오.
   ...
   ![선형 을 표시하는 열 기여도 분석 모델 옵션.](assets/attribution-select.png)
