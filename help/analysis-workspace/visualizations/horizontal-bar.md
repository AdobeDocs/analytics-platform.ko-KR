...
*이 문서는&#x200B;**Customer Journey Analytics**에서 가로 막대 및 가로 막대 누적 시각화에 대해 설명합니다.<br/>이 문서의&#x200B;**Adobe Analytics**버전을 보려면 [가로 막대 및 스택 가로 막대](https://experienceleague.adobe.com/en/docs/analytics/analyze/analysis-workspace/visualizations/horizontal-bar)를 참조하세요.*
