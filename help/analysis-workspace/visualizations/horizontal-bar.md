...
![페이지 보기 수, 페이지 속도, 방문 횟수, 시작 횟수 및 종료 횟수 등의 지표를 보여 주는 가로 막대형](assets/horizontal_bar.png)

## 스택 가로 막대 {#section_50C08E9E20A94024A6553BC352ADB597}

이 시각화는 [!UICONTROL 가로 막대 차트]와 유사하지만 시리즈 막대가 스택되어 표시됩니다.

![페이지 보기 수, 방문 횟수, 시작 수 및 종료 수를 보여 주는 스택 가로 막대형.](assets/horizontal-bar-stacked.png)

스택 막대 시각화에 대한 [!UICONTROL 스택 가로 막대] 시각화 설정은 차트를 &quot;100% 누적&quot; 시각화로 바꿉니다.

![방문 횟수, 페이지 보기 수 및 고유 방문자를 보여주는 100% 누적 가로 막대형](assets/horizstacked100.png)
