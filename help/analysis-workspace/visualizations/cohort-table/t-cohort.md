...
1. (선택 사항) 선택 항목에서 필터를 만듭니다.
   ...
   셀(연속 또는 비연속)을 선택한 다음 > **[!UICONTROL 선택 항목에서 필터 만들기]**&#x200B;를 마우스 오른쪽 단추로 클릭합니다.
