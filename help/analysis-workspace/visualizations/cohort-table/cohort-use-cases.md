...
주요 호텔 체인은 프로모션을 위해 여러 고객 그룹을 대상으로 하며 성과를 추적합니다. 대상으로 가장 적합한 사용자 집단을 식별하기 위해 매우 구체적인 집단을 생성하려고 합니다. 증강 [!UICONTROL 포함] 및 [!UICONTROL 반환] 조건([!UICONTROL 집단] 테이블 내) 사용 시, 여러 지표와 필터가 포함된 올바른 집단 그룹을 정의하면 성과가 낮은 고객 그룹을 식별하고 판촉 행사 및 거래를 통해 예약 증가를 유도할 수 있습니다.
...
대형 의류 판매업체는 비즈니스에 대한 수익의 많은 부분을 생성하는 많은 특정 고객 필터를 제공합니다. 각 필터에는 필터를 고려하여 디자인되고 만들어진 특정 제품이 있습니다. 이러한 소매점은 각 제품이 출시되면 해당 신제품이 시간이 지나면서 다양한 집단에 대한 판매를 어떻게 증가시켰는지 파악하고 싶어합니다. [!UICONTROL 집단 분석]에서 새 [!UICONTROL 지연 테이블] 설정을 사용하여 해당 고객 필터의 사전 실행 및 사후 실행 동작 및 매출을 분석할 수 있습니다. 이 정보를 사용하여 새로운 수익을 창출하는 제품을 식별하고 어떤 제품이 고객의 관심을 끌지 못하는지 파악할 수 있습니다.

## 개인 고착성 - 대부분의 단골 사용자 사용 사례

주요 항공사는 반복적으로 해당 항공사를 이용하는 단골 고객으로부터 비즈니스의 성공을 도모하고 수익을 얻습니다. 대부분의 경우, 단골 여행객이 주요 수익원이며 이러한 고객은 장기적인 성공에 중요합니다. 충성도가 높고 일관된 고객을 식별하는 것은 쉽지 않습니다. 그러나 [!UICONTROL 집단 분석]의 새로운 [!UICONTROL 롤링 계산] 설정을 사용하여 단골 고객 필터를 분석하고 한 달에 걸쳐 반복 구매자이었던 여행자를 확인할 수 있었습니다. 그런 다음 이러한 여행객을 대상으로 충성도에 대한 보상과 혜택을 제공할 수 있습니다. 또한 집단 유형을 유지에서 이탈로 전환함으로써 월별로 반복되지 않은 고객을 파악하고 고객과의 재참여를 유도하고 향후 단골 고객이 될 수 있도록 프로모션을 통해 해당 필터를 대상화할 수 있었습니다.
