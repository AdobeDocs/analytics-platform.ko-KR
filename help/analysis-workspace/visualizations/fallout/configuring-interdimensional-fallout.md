...
예를 들어 페이지 차원 외에도 작업 기반 차원 항목을 폴아웃 시각화에 추가할 수 있습니다. 이렇게 하면 페이지와 특정 작업이 고객의 경로에서 어떻게 상호 작용하는지를 시각화할 수 있습니다.

![여러 차원을 터치포인트로 표시하는 모든 방문 보기.](assets/interdimensional-fallout1.png)
