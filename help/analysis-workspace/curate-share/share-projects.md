...
수신자가 여러 역할에 배치되면 항상 가장 높은 경험을 받게 됩니다. 이는 사용자가 개별 및 그룹의 일부로 모두 추가되는 경우에 발생할 수 있습니다. 예를 들어, 사용자에게 개인 역할을 편집할 **[!UICONTROL 수]** 있고 그룹의 구성원으로 **[!UICONTROL 역할을 볼]** 수 **[!UICONTROL 있다는]** 권한이 주어지면 사용자는프로젝트 편집가능 환경을받게 됩니다.
...
| 사용자가 하나의 역할에서 개별 역할을 수행하고 다른 역할을 그룹의 구성원으로 배치하면 어떻게 됩니까? | 수신자가 여러 역할에 배치되면 항상 더 높은 경험을 받게 됩니다. 예를 들어, 사용자에게 개인 역할을 편집할 **[!UICONTROL 수]** 있고 그룹의 구성원으로 **[!UICONTROL 역할을 볼]** 수 **[!UICONTROL 있다는]** 권한이 주어지면 사용자는프로젝트 편집가능 환경을받게 됩니다. |
| 사용자가 프로젝트 링크를 받을 때 보기 전용 경험을 받는 이유는 무엇입니까? | 받는 사람에게 역할이 할당되지 않고 프로젝트에 대한 링크를 받는 경우(**[!UICONTROL 공유][!UICONTROL > 프로젝트]**&#x200B;가져오기 링크 **** ) 기본적으로역할 보기가능(Can view)에 해당 링크가배치됩니다. 사용자가 향상된 프로젝트 역할을 원할 경우, 프로젝트 소유자 또는 편집자는 이 역할을 복제 가능 또는 프로젝트 공유 모달에서 편집 가능 역할에 추가할 수 있습니다. |
