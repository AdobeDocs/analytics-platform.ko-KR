...
* 수신자가 역할이 할당되지 않은 상태에서 프로젝트에 대한 [링크](/help/analysis-workspace/curate-share/shareable-links.md)를 받은 경우(**[!UICONTROL 공유] > [!UICONTROL 프로젝트 링크 가져오기]**) 수신자는 기본적으로 역할을 받게 됩니다. 관리자 받기 **[!UICONTROL 편집 가능]** 및 관리자가 아닌 사용자가 수신 **[!UICONTROL 복제 가능]**.
...
1. 다음 보안 옵션을 활성화할지 여부를 선택합니다(이 옵션은 CJA 관리자가 제어할 수 있음).
   ...
   * **[!UICONTROL Experience Cloud 인증 필요]:**
      ...
      * 이 옵션이 활성화되고 흐리게 표시되는 경우 CJA 관리자는 Analysis Workspace 프로젝트에 액세스하는 모든 사용자에 대해 Experience Cloud 인증을 요구합니다.
