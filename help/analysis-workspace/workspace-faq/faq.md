...
| 질문 | 답변 |
|--- |--- |
| **Analysis Workspace을 사용하기 위한 사전 요구 사항은 무엇입니까?** | Analysis Workspace을 사용하려면 작업 중인 Customer Journey Analytics 구현이 필요합니다. 도구를 사용하기 전에 조직에서 데이터를 Adobe Experience Platform으로 보내야 합니다. |
