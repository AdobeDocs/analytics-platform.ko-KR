...
| 질문 | 답변 |
|--- |--- |
| **Analysis Workspace를 사용하기 위한 사전 요구 사항은 무엇입니까?** | CJA에서 Analysis Workspace을 사용하려면 작동하는 Customer Journey Analytics 구현이 필요합니다. 도구를 사용하기 전에 조직에서 Adobe Experience Platform에 데이터를 보내도록 하십시오. |
