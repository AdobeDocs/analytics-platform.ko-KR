...
* 중요한 단축키를 사용하는 `F6` 키
* `Tab` 키를 사용하면 개별 요소 간에 이동할 수 있습니다.
...
[!UICONTROL Analysis Workspace]는 보다 매끄러운 워크플로우를 위해 다양한 [키보드 단축키](/help/analysis-workspace/build-workspace-project/fa-shortcut-keys.md) 세트를 제공합니다. 탐색, 분석 제작 및 인사이트 민주화에 대한 몇 가지 일반적인 단축키가 아래에 나와 있습니다.
