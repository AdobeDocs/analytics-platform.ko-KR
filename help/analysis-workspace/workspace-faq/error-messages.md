...
| [!UICONTROL 이 보고서는 너무 복잡합니다. Analysis Workspace 보고서 작성을 위한 모범 사례를 검토하십시오.] | 보고 요청이 너무 커서 실행할 수 없습니다. 이 오류에 기여하는 요소는 요청의 복잡성으로 인해 발생하는 시간 초과입니다. | 요청을 단순화합니다. 예를 들어 날짜 범위를 줄이거나 세그먼트 기준을 단순화하거나 테이블의 일부 열 또는 행을 제거할 수 있습니다. 테이블을 별도 요청으로 분할할 수도 있습니다. |
