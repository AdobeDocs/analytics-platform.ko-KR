...
![파일 보내기 창과 지금 보내기 버튼.](assets/send-file-no-scheduling-options.JPG)

## 일정에 따라 파일 보내기 {#schedule}

이메일을 통해 되풀이되는 일정으로 수신자에게 파일을 보내는 방법:
...
![파일 보내기 창과 시작 날짜, 종료 날짜 및 일일 빈도 설정을 보여 주는 예약 옵션.](assets/send-file.JPG)
...
![예약된 프로젝트 편집 창과 조직에 비밀번호 암호화가 필요하다는 내용의 비밀번호 암호화 알림.](assets/password.png)
...
프로젝트가 일정에 포함되기 전에 프로젝트 소유자는 다음과 유사한 이메일을 받습니다.
