...
title: 클라우드로 Customer Journey Analytics 데이터 내보내기
...
# 클라우드로 Customer Journey Analytics 데이터 내보내기

{{select-package}}

Customer Journey Analytics에서 전체 테이블을 내보내고 데이터를 지정된 클라우드 대상으로 전송할 수 있습니다.
...
1. 다음에서 [!UICONTROL **새 전체 테이블 내보내기**] 대화 상자에서 다음 정보를 지정합니다.
   ...
   | 데이터 미리보기 | 예상 크기, 예상 행 수 및 분류 수를 표시합니다. |
...
* 연결된 값으로 데이터 출력을 구성합니다(예: Adobe Analytics의 Data Warehouse).

* 애드혹 또는 일정에 따라 내보냅니다. (또한 [기타 내보내기 옵션](/help/analysis-workspace/export/export-project-overview.md).)

* 파일을 CSV 또는 PDF 형식으로 내보냅니다. (또한 [기타 내보내기 옵션](/help/analysis-workspace/export/export-project-overview.md).)
...
에 설명된 대로 실패한 내보내기에 대한 지원 티켓을 다시 시도하거나 기록할 수도 있습니다. [내보내기 로그 관리](/help/components/exports/manage-export-logs.md).
...
| 차원 | 5 제한 | 제한 없음 |
| 지표 | 5 제한 | 제한 없음 |
| 행 보고 | 계층에 따라 3, 30, 150 또는 300 제한 | 제한 없음 |
| 보고서 수 | 제한 없음 | 제한 없음 |
| 애드혹 게재 | 예 | 예 |
| 반복 게재 예약 | 예 | 예 |
| 이메일 게재 | 아니요 | 예 |
