...
| 아이콘 | 기능 | 설명 |
|:---:|---|---|
| ![WebPage](/help/assets/icons/WebPage.svg) | **[!UICONTROL 패널]** | [패널](/help/analysis-workspace/c-panels/panels.md)은 프로젝트 내에서 분석을 구성하는 데 사용되며 많은 표와 시각화를 포함할 수 있습니다. Analysis Workspace에서 제공되는 많은 패널은 몇 개의 사용자 입력을 기반으로 전체 분석 집합을 생성합니다. |
...
| **[!UICONTROL 저장]** | **[!UICONTROL *Cmd+S *]** | **[!UICONTROL *Ctrl+S *]** | [프로젝트 저장](/help/analysis-workspace/build-workspace-project/save-projects.md#save-projects). |
| **[!UICONTROL 메모와 함께 저장...]** | **[!UICONTROL *Opt+Cmd+S *]** | **[!UICONTROL *Alt+Ctrl+S *]** | [저장한 프로젝트 버전에 메모 추가](/help/analysis-workspace/build-workspace-project/save-projects.md#save-project-options). |
| **[!UICONTROL 다른 이름으로 저장...]** | **[!UICONTROL *Shift+Cmd+S *]** | **[!UICONTROL *Shift+Ctrl+S *]** | [다른 이름 및 세부 정보를 사용하여 프로젝트를 저장합니다.](/help/analysis-workspace/build-workspace-project/save-projects.md#save-project-options) |
...
| **[!UICONTROL 실험]** | **[!UICONTROL *Opt+X *]** | **[!UICONTROL *Alt+X *]** | [실험](/help/analysis-workspace/c-panels/experimentation.md) 패널을 삽입하다. |
...
| **[!UICONTROL 대상자 만들기...]** | **[!UICONTROL *Shift+Cmd+U *]** | **[!UICONTROL *Shift+Ctrl+U *]** | 새 [대상자](/help/components/audiences/audiences-overview.md)를 만듭니다. |
...
| **[!UICONTROL 모두와 공유]** | **[!UICONTROL *Opt+L *]** | **[!UICONTROL *Alt+L *]** | [모두와 읽기 전용 버전의 프로젝트 공유](/help/analysis-workspace/curate-share/share-projects.md#share-a-link-to-a-project). |
| **[!UICONTROL 파일 보내기]** | **[!UICONTROL Opt+S]** | **[!UICONTROL *Alt+S *]** | [프로젝트를 다른 수신자에게 CSV 또는 PDF 파일로 전송](/help/analysis-workspace/curate-share/send-schedule-files.md). |
...
시각화를 동기화하여 시각화에 해당하는 데이터 테이블 또는 데이터 소스를 제어합니다. 자세한 내용은 [데이터 소스 관리](/help/analysis-workspace/visualizations/t-sync-visualization.md)를 참조하십시오.
...
프로젝트 빌드를 완료하고 프로젝트에서 실행 가능한 인사이트를 수집하면 다른 사람이 프로젝트를 사용할 수도 있습니다. 조직의 사용자 및 그룹은 물론 조직 외부의 사람들과도 프로젝트를 공유할 수 있습니다. 프로젝트 공유에 대한 내용은 [프로젝트 공유](/help/analysis-workspace/curate-share/share-projects.md)를 참조하십시오.
