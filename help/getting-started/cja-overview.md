...
* 2020년 9월 9일부터 Customer Journey Analytics에 액세스하거나 연결을 만들려면 **관리 콘솔**&#x200B;에서 [Customer Jorney Analytics 제품 프로필](https://adminconsole.adobe.com/enterprise/)에 관리자로 추가되어 있어야 합니다. 관리자는 다음 권한이 필요합니다.
