...
| 영업 기회(선택 사항) | 함께 판매되는 제품 및 서비스의 컬렉션입니다. 영업 종료 직전까지 영업 주기의 여러 단계가 절정에 이른 경우가 많았다.<br>데이터를 사용하여 영업 funnel을 통한 영업 기회 진행률을 측정합니다. 예를 들어 3단계에서 4단계로 이동한 상위 기회에 대한 세부 정보를 제공하는 보고서입니다. |
...
![계정 기반 연결 예제](assets/b2b-datasets.png)
