...
이제 Analysis Workspace에서 패널을 분류할 수 있습니다. 패널에 세그먼트를 적용하는 것보다 패널의 데이터 및 시각화 분류를 선호하는 시나리오가 있습니다.

[![이미지](assets/learn-more-button.svg)](/help/analysis-workspace/c-panels/panels.md#break-down-a-panel)

>[!TAB 여러 차원 열]

자유 형식 테이블에 최대 5개의 차원 열을 포함할 수 있으므로 여러 차원 항목을 나란히 볼 수 있습니다. 차원 항목의 각 행은 연결된 단일 차원 항목처럼 작동합니다.

[![이미지](assets/learn-more-button.svg)](/help/analysis-workspace/visualizations/freeform-table/freeform-table-multidimensions.md)

>[!TAB 연결 결합]

이제 Customer Journey Analytics 연결 UI 내에서 직접 이벤트 데이터 세트에 대한 결합을 구성하고 활성화할 수 있습니다.

[![이미지](assets/learn-more-button.svg)](/help/stitching/use-stitching-ui.md)

*연결을 사용하려면 Select 패키지가 적어도 있어야 합니다.*


>[!TAB 대상 분석]

대상 분석을 사용하면 Experience Platform 프로필 데이터 세트의 대상 멤버십 데이터를 Customer Journey Analytics 연결로 수집할 수 있습니다.

[![이미지](assets/learn-more-button.svg)](/help/connections/audience-analysis/analyze-audiences.md)
...
*실시간 보고를 위해서는 Ultimate 패키지가 필요합니다.*
...
<table style="table-layout:fixed">
  <tr style="border: 0;">
    ...
    <div><strong>데이터 수집 및 사용</strong><br/>데이터를 Experience Platform에 수집하여 분석 및 보고에 사용해야 하는 옵션에 대해 알아봅니다.</div>
    </td>
    <td>
    <a href="/help/guided-analysis/overview.md"><img src="./assets/product-analytics.png"></a>
    <div><strong>가이드 분석</strong><br/>워크플로를 사용하여 고객의 제품 경험에 대한 데이터와 인사이트를 얻는 방법을 알아봅니다. 가이드 분석을 통한 Product Analytics.
    </div>
    </td>
    <td>
    ...
    <div><strong>Content Analytics</strong><br/>동작 옆에 있는 콘텐츠가 주요 성능 지표에 미치는 영향을 이해합니다. 고객 여정 데이터에 대한 심층적인 통찰력을 얻으십시오.</div>
    </td>
  </tr>
  <tr style="border: 0;">
...
<table style="table-layout:fixed">
  ...
  <tr style="border: 0;">
    ...
    <td>
      ...
      <strong>기타...</strong><br/><a href="/help/guided-analysis/overview.md">분석 가이드</a> - <a href="/help/content-analytics/content-analytics.md">Content Analytics</a> - <a href="/help/getting-started/cja-b2b-edition.md">B2B edition</a> 
    </td>
  </tr>
</table>
