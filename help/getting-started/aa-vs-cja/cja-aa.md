...
| **데이터 보기 전반에 공유된 지표 및 차원** | [여러 데이터 보기에서 차원 및 지표 설정을 적용](/help/data-views/shared-metrics-dimensions/smd-overview.md)할 수 있습니다. 공유 차원 또는 지표에 대한 변경 사항은 적용 가능한 모든 데이터 보기에서 해당 차원 또는 지표의 모든 인스턴스에 적용됩니다. |
