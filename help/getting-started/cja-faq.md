...
![Edge Network를 사용한 데이터 흐름](https://experienceleague.adobe.com/docs/experience-platform/assets/collection.png?lang=en)
...
Experience Edge 네트워크 및 지역 데이터 센터 외부의 데이터 수집 프로세스에 대한 자세한 내용은 [데이터 수집 개요](https://experienceleague.adobe.com/docs/experience-platform/collection/home.html?lang=ko)를 참조하십시오.
