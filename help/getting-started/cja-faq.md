...
## &#x200B;3. [!UICONTROL Customer Journey Analytics]에 데이터를 가져오는 중 {#ingest}
...
* 라이브 데이터 또는 이벤트: Adobe Experience Platform에서 데이터를 사용할 수 있게 되면 90분 이내에 처리 및 수집됩니다. (배치 크기 > 5천만 행: 90분 이상) 결합이 활성화된 경우 수집에는 최대 4시간이 소요될 수 있습니다. 자세한 내용은 [가드레일](https://experienceleague.adobe.com/ko/docs/analytics-platform/using/technotes/guardrails)을 참조하십시오.
* 소규모 채우기: 7일 이내
* 대규모 채우기: 30일 이내
...
## &#x200B;6. 개체 또는 구성 요소 삭제의 영향 {#deletion}

Customer Journey Analytics나 Experience Platform 오브젝트 또는 구성 요소를 삭제하거나 재설정할 때의 영향에 대한 개요는 [삭제 및 재설정의 영향](/help/technotes/deletion.md)을 참조하십시오.
