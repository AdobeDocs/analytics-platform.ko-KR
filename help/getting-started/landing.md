...
| [!UICONTROL **다음 사용자와 공유**] | 현재 프로젝트를 누구와 공유하고 있는지 표시합니다. |
| [!UICONTROL **마지막 수정일**] | 프로젝트가 마지막으로 수정된 일자와 시간입니다. |
| [!UICONTROL **마지막으로 연 날짜**] | 현재 프로젝트 페이지를 보고 있는 사용자가 프로젝트를 마지막으로 연 일자를 나타냅니다. |
| [!UICONTROL **마지막 사용**] | 조직의 사용자가 프로젝트를 마지막으로 연 일자와 시간을 표시해 주므로 프로젝트가 조직 내 사용자에게 가치가 있는지 여부를 판단하는 데 도움이 됩니다.<p>이 열을 볼 때는 다음 사항을 고려하십시오.</p><ul><li>사용 정보는 2023년 9월부터 제공됩니다.</li><li>이 열은 시스템 관리자만 사용할 수 있습니다.</li></ul> |
