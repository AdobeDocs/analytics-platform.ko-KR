...
1. B2B 데이터를 모델링합니다. [XDM(Adobe Experience Data Model)](https://experienceleague.adobe.com/docs/experience-platform/xdm/home.html?lang=ko)을 사용하여 B2B 데이터를 표준화하고 B2B 데이터에 대한 스키마를 정의할 수 있습니다.<br/>Real-Time CDP B2B edition[&#128279;](https://experienceleague.adobe.com/ko/docs/experience-platform/rtcdp/schemas/b2b)에서 제공되는 표준 클래스를 기반으로 스키마를 지정하거나 사용자 정의 클래스와 스키마를 사용할 수 있습니다. [사용 사례](/help/use-cases/b2b/b2b-edition/use-cases-overview.md) 문서에서는 Real-Time CDP B2B edition 클래스 및 스키마를 사용하지만 표준 클래스 및 스키마를 활용하는 데에는 Real-Time CDP B2B edition 라이선스가 필요하지 않습니다. <br/>Customer Journey Analytics B2B edition은 최소한 계정 기반 시계열 이벤트 데이터를 사용하고 있으며 추가 프로필 또는 조회 레코드 데이터의 이점을 제공합니다. 계정 데이터, 구매 그룹 데이터, 기회 데이터, 마케팅 목록 멤버 데이터 등.
