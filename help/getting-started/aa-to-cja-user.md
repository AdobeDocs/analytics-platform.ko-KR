...
* [Report Builder](/help/report-builder/rb-overview.md)에는 새로운 인터페이스가 있고 MS Windows, MacOS 및 Excel 웹 버전에서 실행됩니다. 이전 버전의 Report Builder에서는 VMware를 사용하지 않으면 Mac에서 실행할 수 없었습니다. 이번 버전은 아직 기존 AA 데이터 요청을 지원하지 않습니다.
