...
| **Experience Cloud ID (ECID) 사용 가능** | 아니요 | 아니요 | 예 | 예 | 아니요 | 아니요 |
...
| **낮은 트래픽 (고유 수가 초과되었습니다) 표시** <br> [자세히 알아보기](/help/components/dimensions/high-cardinality.md) | 예 | 예 | 아니요 | 아니요 | 예 | 예 |
| **표시 행 제한 (페이지 매김 전)** | 400 | 50,000 | 제한 없음 | 제한 없음 | 50,000 | 50,000 |
