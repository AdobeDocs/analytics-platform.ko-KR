...
* **세션**: 전환이 발생한 세션 시작 부분까지 되돌아봅니다. 세션 전환 확인 기간은 데이터 보기에서 수정된 [세션 시간 초과](/help/data-views/create-dataview.md#session-settings)를 따릅니다. **[!UICONTROL 세션]**&#x200B;을(를) 선택하면 [속성 전환 확인 기간](#atribution-lookback-window)이(가) 자동으로 **[!UICONTROL 보고 기간]**(으)로 설정되며 변경할 수 없습니다.
...
보고 기간(예: 9월 10일 - 9월 24일)에 따라 속성 모델, 컨테이너 및 채널은 서로 다른 크레딧을 받습니다. 아래 테이블을 참조하십시오.
