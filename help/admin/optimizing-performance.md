...
다양한 요소가 전체 CJA 성능 및 Analysis Workspace 내의 프로젝트 성능에 영향을 줄 수 있습니다.
...
| 자유 형식 셀 개수 | 모든 테이블의 행과 열을 곱하여 계산한 프로젝트의 총 자유 형식 테이블 셀 수입니다. 숨겨진 데이터 소스를 제외합니다. 지침은 4,000개입니다. | 테이블의 열 수를 가장 관련성이 높은 데이터 포인트로만 줄입니다. 표시된 행 수를 조정하거나 표 필터를 적용하거나 필터를 적용하여 테이블의 행 수를 줄입니다. |
