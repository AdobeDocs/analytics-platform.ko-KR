...
다양한 요소가 Analysis Workspace 내의 프로젝트 성과뿐만 아니라 전체 CJA 성과에 영향을 줄 수 있습니다. 작업 영역에서 &quot;이 보고서가 너무 복잡합니다&quot;라는 오류 메시지가 표시될 수 있습니다. [이것이 메시지의 정확한 표현인가요?] 이 항목에서는 이 오류가 발생할 수 있는 요인과 보고서/프로젝트를 간소화하는 방법에 대해 설명합니다.
