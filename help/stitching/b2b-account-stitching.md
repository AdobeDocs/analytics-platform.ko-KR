...
>title="개인 식별자 네임스페이스"
>abstract="보고에 가장 관련성이 높은 개인 ID 네임스페이스를 선택합니다. 이메일 등을 예로 들 수 있습니다."
...
>title="계정"
>abstract="고유 계정 식별자 값이 포함된 데이터 세트의 필드를 선택합니다. 계정 ID 정보는 개인 대 계정 연결이 활성화된 이벤트 데이터 세트의 행에서 사용할 수 있습니다."
...
>title="개인 - 계정 결합 활성화"
>abstract="활성화된 경우 이 데이터 세트는 B2B 개인과 계정 간의 결합을 사용합니다. **[!UICONTROL 개인 ID]** 값은 구성된 개인 식별자 네임스페이스의 값으로 상승한 다음 **[!UICONTROL 개인 대 계정 데이터 세트]**(B2B 결합 구성 인터페이스)를 기반으로 계정 ID를 조회하는 데 사용됩니다.<br/>비활성화된 경우 이 데이터 세트는 B2B 개인 대 계정 결합을 사용하지 않으며 대신 필수 **[!UICONTROL 계정 ID]**&#x200B;을(를) 선택해야 합니다."
