...
>title="B2B 계정 연결 구성"
>abstract="**[!UICONTROL B2B 연결 구성 열기]**&#x200B;를 선택하여 B2B 계정 연결을 구성합니다. 연결이 아직 저장되지 않은 경우 구성에 **[!UICONTROL _저장하지 않은 변경 내용_]** 레이블이 지정됩니다."

>[!CONTEXTUALHELP]
>id="connection_b2b_stitching_person_identifier_namespace"
>title="개인 식별자 네임스페이스"
>abstract="개인 ID를 높이고자 하는 개인 식별자 네임스페이스(예: 이메일)를 선택합니다."

>[!CONTEXTUALHELP]
>id="connection_b2b_stitching_person_to_account_dataset"
>title="계정 데이터 세트에 대한 개인"
...
>title="개인 계정 연결 활성화"
>abstract="활성화된 경우 이 데이터 세트는 B2B 계정 결합을 사용합니다. 선택한 개인 ID는 개인-계정 데이터 세트를 기반으로 계정 ID를 조회하는 데 사용됩니다.<br/>사용하지 않도록 설정된 경우 이 데이터 집합은 B2B 계정 연결을 사용하지 *않습니다*."
>additional-url=""
>additional-url=""
