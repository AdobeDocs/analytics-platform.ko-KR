...
>title="개인 - 계정 데이터 세트"
>abstract="개인 ID가 포함된 데이터 세트에서 필드를 선택합니다. 이 필드의 네임스페이스는 선택한 개인 식별자 네임스페이스(B2B 결합 구성)와 다르거나 동일할 수 있습니다. 두 네임스페이스가 다른 경우 ID 그래프에서 네임스페이스를 연결합니다."
...
>title="계정"
>abstract="고유 계정 식별자 값이 포함된 데이터 세트의 필드를 선택합니다. 계정 ID 정보는 연결이 활성화된 모든 이벤트 데이터 세트의 행에서 사용할 수 있습니다."
...
>title="개인 - 계정 결합 활성화"
>abstract="활성화된 경우 이 데이터 세트는 B2B 계정 결합을 사용합니다. 개인-계정 데이터 세트를 기반으로 계정 ID를 조회하려면 필요한 **[!UICONTROL 개인 ID]**&#x200B;를 선택합니다.<br/>비활성화된 경우 이 데이터 세트는 B2B 계정 결합을 사용하지 *않으며*, 대신 필요한 **[!UICONTROL 계정 ID]**&#x200B;를 선택해야 합니다."
