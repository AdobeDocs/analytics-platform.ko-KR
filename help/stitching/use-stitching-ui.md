---
title: 결합 활성화
description: Customer Journey Analytics에서 이벤트 데이터 세트에 대한 결합을 활성화합니다. 연결 UI에서 영구 ID, 개인 ID 및 재생 창을 구성합니다.
...
1. **[!UICONTROL 영구 ID]** 드롭다운 메뉴에서 영구 ID를 선택합니다.
   ...
   영구 ID에 대해 **[!UICONTROL ID 맵]**&#x200B;을(를) 선택하는 경우 네임스페이스를 선택하십시오. 다음 두 가지 옵션이 있습니다.
...
1. **[!UICONTROL 개인 ID]** 드롭다운 메뉴에서 개인 ID를 선택합니다.
   ...
   개인 ID로 **[!UICONTROL ID 맵]**&#x200B;을(를) 선택하는 경우 네임스페이스를 선택하세요. 다음 두 가지 옵션이 있습니다.
...
기능을 사용하도록 설정할 때 ![ID 결합 옵션](assets/identity-stitching-ui-preview.png)

#### 결합 지표

>[!AVAILABILITY]
>
>그래프 기반 결합에는 결합 지표를 사용할 수 없습니다.
>
