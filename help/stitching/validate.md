...
결합 프로세스 후에 전자 메일 주소가 설정된 이벤트를 보려면 계산된 지표 `Email stitched namespace`을(를) 정의하십시오. 해당 계산된 지표는 해시된 이메일 네임스페이스 **[!UICONTROL 과(와) 같은]** ID 네임스페이스&#x200B;**[!UICONTROL 가 있는]**&#x200B;이벤트`email_lc_sha256`을(를) 봅니다.
